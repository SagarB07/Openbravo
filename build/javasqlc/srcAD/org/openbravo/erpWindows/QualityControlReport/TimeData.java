 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Measurehour = TO_TIMESTAMP(?,'HH24:MI:SS') , MA_Measure_Group_ID = (?) , Explode = (?) , Processed = (?) , IsActive = (?) , AD_Org_ID = (?) , MA_Measure_Time_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE MA_Measure_Time.MA_Measure_Time_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Measurehour, MA_Measure_Group_ID, Explode, Processed, IsActive, AD_Org_ID, MA_Measure_Time_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
