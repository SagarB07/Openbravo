 ...
 */
  public static String selectAux1570DEA796EC4EE0A9AB562BC2E14C66(ConnectionProvider connectionProvider, String FIN_RECONCILIATION_ID)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "CASEWHENMAX(FIN_RECONCILIATION_ID)ISNULLTHEN'N'ELSE'Y'END");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Isactive, FIN_Financial_Account_ID, DocumentNo, C_Doctype_ID, Widget, Dateto, Statementdate, Startingbalance, EM_APRM_PrintDetailed, Printdetailed, EM_APRM_PrintSummary, Endingbalance, Printsummary, Docstatus, Processing, Processed, Posted, EM_APRM_Process_Reconciliation, EM_Aprm_Process_Rec, EM_APRM_Process_Rec_Force, AD_Client_ID, FIN_Reconciliation_ID, created, createdby, updated, updatedBy)" +
