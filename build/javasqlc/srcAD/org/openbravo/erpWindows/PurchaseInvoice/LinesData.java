 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Line, Financial_Invoice_Line, M_Product_ID, Account_ID, QtyInvoiced, C_UOM_ID, PriceActual, Gross_Unit_Price, LineNetAmt, Line_Gross_Amount, Description, C_Tax_ID, PriceList, Grosspricelist, M_AttributeSetInstance_ID, C_OrderLine_ID, M_InOutLine_ID, IsDeferred, Taxbaseamt, Excludeforwithholding, C_Charge_ID, TaxAmt, Iseditlinenetamt, QuantityOrder, M_Product_Uom_Id, PriceStd, grosspricestd, DefPlanType, Periodnumber, C_Period_ID, AD_Org_ID, C_Bpartner_ID, C_Project_ID, C_Costcenter_ID, A_Asset_ID, User1_ID, User2_ID, Explode, BOM_Parent_ID, S_ResourceAssignment_ID, ChargeAmt, C_InvoiceLine_ID, AD_Client_ID, C_Invoice_ID, IsActive, PriceLimit, M_Offer_ID, C_Invoice_Discount_ID, IsDescription, C_Projectline_ID, created, createdby, updated, updatedBy)" +
