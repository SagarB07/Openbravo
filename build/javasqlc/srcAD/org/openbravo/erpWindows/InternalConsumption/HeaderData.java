 ...
 */
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "(CASE WHEN M_Internal_Consumption.AD_Org_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table1.Value), ''))),'') ) END) AS AD_Org_IDR, " +
      ...
      "        ? AS LANGUAGE " +
      "        FROM M_Internal_Consumption left join (select AD_Org_ID, Value from AD_Org) table1 on (M_Internal_Consumption.AD_Org_ID = table1.AD_Org_ID)" +
      "        WHERE 2=2 " +
      "        AND 1=1 " +
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , MovementDate = TO_DATE(?) , Name = (?) , Processing = (?) , M_Internal_Consumption_ID = (?) , AD_Client_ID = (?) , Status = (?) , Processed = (?) , Posted = (?) , Description = (?) , IsActive = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, MovementDate, Name, Processing, M_Internal_Consumption_ID, AD_Client_ID, Status, Processed, Posted, Description, IsActive, created, createdby, updated, updatedBy)" +
