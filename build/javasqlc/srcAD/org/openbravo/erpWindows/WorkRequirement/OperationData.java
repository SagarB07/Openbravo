 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (SeqNo, MA_Sequence_ID, MA_Process_ID, Startdate, Enddate, Estimatedtime, Runtime, Quantity, Donequantity, CostCenterUse, Description, Noqty, Groupuse, Closed, Outsourced, Preptime, Usedmaterial, IsActive, AD_Org_ID, MA_Workrequirement_ID, Name, MA_Wrphase_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
