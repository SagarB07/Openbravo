  ...
  public static AccountTreeData[] select(ConnectionProvider connectionProvider, String conCodigo, String adTreeId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectAccountTreeData.monthoftrx = UtilSql.getValue(result, "MONTHOFTRX");
        objectAccountTreeData.accounttype = UtilSql.getValue(result, "ACCOUNTTYPE");
        objectAccountTreeData.position = UtilSql.getValue(result, "POSITION");
        objectAccountTreeData.qtyBef = UtilSql.getValue(result, "QTY_BEF");
        objectAccountTreeData.qtycreditBef = UtilSql.getValue(result, "QTYCREDIT_BEF");
        objectAccountTreeData.qtyOperationBef = UtilSql.getValue(result, "QTY_OPERATION_BEF");
        objectAccountTreeData.svcresetbef = UtilSql.getValue(result, "SVCRESETBEF");
        objectAccountTreeData.elevel = UtilSql.getValue(result, "ELEVEL");
