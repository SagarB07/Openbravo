...
class GeneralAccountingRptData implements FieldProvider {
static Logger log4j = Logger.getLogger(GeneralAccountingRptData.class);
  private String InitRecordNumber="0";
  public String id;
  public String name;
  public String isbalanced;
  public String description;
  public String emGarRptname;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("ID"))
      ...
      return description;
    else if (fieldName.equalsIgnoreCase("EM_GAR_RPTNAME") || fieldName.equals("emGarRptname"))
      return emGarRptname;
  ...
  public static GeneralAccountingRptData[] selectRpt(ConnectionProvider connectionProvider, String org, String client, String acctschema)    throws ServletException {
    return selectRpt(connectionProvider, org, client, acctschema, 0, 0);
  }

  public static GeneralAccountingRptData[] selectRpt(ConnectionProvider connectionProvider, String org, String client, String acctschema, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "		SELECT COALESCE(REPORTTYPE,'N') || C_ACCT_RPT_ID AS ID, NAME, ISORGBALANCED AS ISBALANCED,description, '' AS em_gar_rptname" +
      "		FROM C_ACCT_RPT" +
      "		WHERE AD_ORG_ID IN (";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        GeneralAccountingRptData objectGeneralAccountingRptData = new GeneralAccountingRptData();
        objectGeneralAccountingRptData.id = UtilSql.getValue(result, "ID");
        objectGeneralAccountingRptData.name = UtilSql.getValue(result, "NAME");
        objectGeneralAccountingRptData.isbalanced = UtilSql.getValue(result, "ISBALANCED");
        objectGeneralAccountingRptData.description = UtilSql.getValue(result, "DESCRIPTION");
        objectGeneralAccountingRptData.emGarRptname = UtilSql.getValue(result, "EM_GAR_RPTNAME");
        objectGeneralAccountingRptData.pagebreak = "";
        objectGeneralAccountingRptData.padre = "";
        objectGeneralAccountingRptData.begining = "";
        objectGeneralAccountingRptData.end = "";
        objectGeneralAccountingRptData.previousYear = "";
        objectGeneralAccountingRptData.previousYearId = "";
        objectGeneralAccountingRptData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectGeneralAccountingRptData);
    ...
    GeneralAccountingRptData objectGeneralAccountingRptData[] = new GeneralAccountingRptData[vector.size()];
    vector.copyInto(objectGeneralAccountingRptData);
    return(objectGeneralAccountingRptData);
  }

  public static GeneralAccountingRptData[] selectRptDouble(ConnectionProvider connectionProvider)    throws ServletException {
    return selectRptDouble(connectionProvider, 0, 0);
  }

  public static GeneralAccountingRptData[] selectRptDouble(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        GeneralAccountingRptData objectGeneralAccountingRptData = new GeneralAccountingRptData();
        objectGeneralAccountingRptData.padre = UtilSql.getValue(result, "PADRE");
        objectGeneralAccountingRptData.id = UtilSql.getValue(result, "ID");
        objectGeneralAccountingRptData.name = UtilSql.getValue(result, "NAME");
        objectGeneralAccountingRptData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectGeneralAccountingRptData);
  ...
  public static GeneralAccountingRptData[] selectGroups(ConnectionProvider connectionProvider, String rpt)    throws ServletException {
    return selectGroups(connectionProvider, rpt, 0, 0);
  }

  public static GeneralAccountingRptData[] selectGroups(ConnectionProvider connectionProvider, String rpt, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT C_ACCT_RPT_GROUP_ID AS ID, name, 'page' as pagebreak, description" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectGeneralAccountingRptData.id = UtilSql.getValue(result, "ID");
        objectGeneralAccountingRptData.name = UtilSql.getValue(result, "NAME");
        objectGeneralAccountingRptData.pagebreak = UtilSql.getValue(result, "PAGEBREAK");
        objectGeneralAccountingRptData.description = UtilSql.getValue(result, "DESCRIPTION");
        objectGeneralAccountingRptData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectGeneralAccountingRptData);
        if (countRecord >= numberRegisters && numberRegisters != 0) {
  ...
  public static String selectRptName(ConnectionProvider connectionProvider, String rpt)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT em_gar_rptname" +
      "        FROM C_ACCT_RPT" +
      "        WHERE C_ACCT_RPT_ID = ?";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "EM_GAR_RPTNAME");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
  ...
  public static GeneralAccountingRptData[] selectElements(ConnectionProvider connectionProvider, String grp)    throws ServletException {
    return selectElements(connectionProvider, grp, 0, 0);
  }

  public static GeneralAccountingRptData[] selectElements(ConnectionProvider connectionProvider, String grp, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static String selectPyGMutasi(ConnectionProvider connectionProvider, String accountType, String monthacct, String acctschema, String year, String adOrgId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT COALESCE(SUM(AMTACCTCR-AMTACCTDR), 0) AS NAME" +
      "      FROM FACT_ACCT, C_PERIOD, C_YEAR, (SELECT C_ELEMENTVALUE_ID" +
      ...
      "     AND FACT_ACCT.FACTACCTTYPE <> 'R'" +
      "     AND 1=1";
    strSql = strSql + ((monthacct==null || monthacct.equals(""))?"":"  AND EXTRACT(MONTH from FACT_ACCT.dateacct) = ? ");
    strSql = strSql + ((acctschema==null || acctschema.equals(""))?"":"  AND FACT_ACCT.C_ACCTSCHEMA_ID = ? ");
    strSql = strSql + 
      "     AND C_YEAR.YEAR IN (";
    strSql = strSql + ((year==null || year.equals(""))?"":year);
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, accountType);
      if (monthacct != null && !(monthacct.equals(""))) {
  ...
  public static GeneralAccountingRptData[] selectOrgsDouble(ConnectionProvider connectionProvider, String adClient, String adOrg)    throws ServletException {
    return selectOrgsDouble(connectionProvider, adClient, adOrg, 0, 0);
  }

  public static GeneralAccountingRptData[] selectOrgsDouble(ConnectionProvider connectionProvider, String adClient, String adOrg, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static GeneralAccountingRptData[] selectYearsDouble(ConnectionProvider connectionProvider, String Client)    throws ServletException {
    return selectYearsDouble(connectionProvider, Client, 0, 0);
  }

  public static GeneralAccountingRptData[] selectYearsDouble(ConnectionProvider connectionProvider, String Client, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
