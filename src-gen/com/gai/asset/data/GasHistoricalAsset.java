...
/**
 * Entity class for entity GAS_HISTORICAL_ASSET (stored in table GAS_HISTORICAL_ASSET).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class GasHistoricalAsset extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "GAS_HISTORICAL_ASSET";
    public static final String ENTITY_NAME = "GAS_HISTORICAL_ASSET";
    ...
    public static final String PROPERTY_PIC = "pIC";
    ...
    public User getPIC() {
        return (User) get(PROPERTY_PIC);
    }

    public void setPIC(User pIC) {
        set(PROPERTY_PIC, pIC);
    }
