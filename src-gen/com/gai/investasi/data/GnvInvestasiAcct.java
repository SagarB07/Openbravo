...
/**
 * Entity class for entity GNV_INVESTASI_ACCT (stored in table GNV_INVESTASI_ACCT).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class GnvInvestasiAcct extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "GNV_INVESTASI_ACCT";
    public static final String ENTITY_NAME = "GNV_INVESTASI_ACCT";
    ...
    public static final String PROPERTY_ACCUMDEPRECIATIONACCT = "accumdepreciationAcct";
    ...
    public void setAccumdepreciationAcct(AccountingCombination accumdepreciationAcct) {
