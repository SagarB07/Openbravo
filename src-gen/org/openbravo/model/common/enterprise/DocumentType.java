...
public class DocumentType extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_FINANCIALMGMTASSETEMGASDOCTYPEIDLIST = "financialMgmtAssetEMGasDoctypeIDList";
    ...
    public DocumentType() {
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTASSETEMGASDOCTYPEIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Asset> getFinancialMgmtAssetEMGasDoctypeIDList() {
      return (List<Asset>) get(PROPERTY_FINANCIALMGMTASSETEMGASDOCTYPEIDLIST);
    }

    public void setFinancialMgmtAssetEMGasDoctypeIDList(List<Asset> financialMgmtAssetEMGasDoctypeIDList) {
        set(PROPERTY_FINANCIALMGMTASSETEMGASDOCTYPEIDLIST, financialMgmtAssetEMGasDoctypeIDList);
    }
