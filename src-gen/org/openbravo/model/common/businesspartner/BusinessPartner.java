...
import com.gai.investasi.data.GnvMasterRasioKeuangan;
import com.gai.procurement.persetujuan.data.GppPerspembelian;
import com.gai.procurement.persetujuan.data.GppPerspembline;
...
public class BusinessPartner extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GNVMASTERRASIOKEUANGANLIST = "gNVMasterRasioKeuanganList";
    ...
    public BusinessPartner() {
        ...
        setDefaultValue(PROPERTY_GNVMASTERRASIOKEUANGANLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<GnvMasterRasioKeuangan> getGNVMasterRasioKeuanganList() {
      return (List<GnvMasterRasioKeuangan>) get(PROPERTY_GNVMASTERRASIOKEUANGANLIST);
    }

    public void setGNVMasterRasioKeuanganList(List<GnvMasterRasioKeuangan> gNVMasterRasioKeuanganList) {
        set(PROPERTY_GNVMASTERRASIOKEUANGANLIST, gNVMasterRasioKeuanganList);
    }
