...
public class Location extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GPRNPWP = "gprNpwp";
    ...
    public String getGprNpwp() {
        return (String) get(PROPERTY_GPRNPWP);
    }

    public void setGprNpwp(String gprNpwp) {
        set(PROPERTY_GPRNPWP, gprNpwp);
    }
