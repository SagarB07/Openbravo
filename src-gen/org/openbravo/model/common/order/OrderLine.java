...
public class OrderLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_FINANCIALMGMTASSETEMGASORDERLINEIDLIST = "financialMgmtAssetEMGasOrderlineIDList";
    ...
    public OrderLine() {
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTASSETEMGASORDERLINEIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Asset> getFinancialMgmtAssetEMGasOrderlineIDList() {
      return (List<Asset>) get(PROPERTY_FINANCIALMGMTASSETEMGASORDERLINEIDLIST);
    }

    public void setFinancialMgmtAssetEMGasOrderlineIDList(List<Asset> financialMgmtAssetEMGasOrderlineIDList) {
        set(PROPERTY_FINANCIALMGMTASSETEMGASORDERLINEIDLIST, financialMgmtAssetEMGasOrderlineIDList);
    }
