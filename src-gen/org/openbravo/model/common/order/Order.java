...
import com.gai.budget.data.GBGPurchaseOrderV;
...
public class Order extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GASBTNCREATEASSET = "gasBtncreateasset";
    public static final String PROPERTY_GPROFFERDATE = "gprOfferdate";
    public static final String PROPERTY_GPROFFERNO = "gprOfferno";
    public static final String PROPERTY_GPRPENGIRIMANVIA = "gprPengirimanVia";
    public static final String PROPERTY_GPRFOB = "gprFob";
    public static final String PROPERTY_GPRJANGKAWAKTU = "gprJangkaWaktu";
    ...
    public static final String PROPERTY_GBGPURCHASEORDERVLIST = "gBGPurchaseOrderVList";
    ...
    public Order() {
        ...
        setDefaultValue(PROPERTY_GASBTNCREATEASSET, false);
        setDefaultValue(PROPERTY_GPRFOB, new BigDecimal(0));
        ...
        setDefaultValue(PROPERTY_GBGPURCHASEORDERVLIST, new ArrayList<Object>());
    ...
    public Boolean isGasBtncreateasset() {
        return (Boolean) get(PROPERTY_GASBTNCREATEASSET);
    }

    public void setGasBtncreateasset(Boolean gasBtncreateasset) {
        set(PROPERTY_GASBTNCREATEASSET, gasBtncreateasset);
    }

    public Date getGprOfferdate() {
        return (Date) get(PROPERTY_GPROFFERDATE);
    }

    public void setGprOfferdate(Date gprOfferdate) {
        set(PROPERTY_GPROFFERDATE, gprOfferdate);
    }

    public String getGprOfferno() {
        return (String) get(PROPERTY_GPROFFERNO);
    }

    public void setGprOfferno(String gprOfferno) {
        set(PROPERTY_GPROFFERNO, gprOfferno);
    }

    public String getGprPengirimanVia() {
        return (String) get(PROPERTY_GPRPENGIRIMANVIA);
    }

    public void setGprPengirimanVia(String gprPengirimanVia) {
        set(PROPERTY_GPRPENGIRIMANVIA, gprPengirimanVia);
    }

    public BigDecimal getGprFob() {
        return (BigDecimal) get(PROPERTY_GPRFOB);
    }

    public void setGprFob(BigDecimal gprFob) {
        set(PROPERTY_GPRFOB, gprFob);
    }

    public String getGprJangkaWaktu() {
        return (String) get(PROPERTY_GPRJANGKAWAKTU);
    }

    public void setGprJangkaWaktu(String gprJangkaWaktu) {
        set(PROPERTY_GPRJANGKAWAKTU, gprJangkaWaktu);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GBGPurchaseOrderV> getGBGPurchaseOrderVList() {
      return (List<GBGPurchaseOrderV>) get(PROPERTY_GBGPURCHASEORDERVLIST);
    }

    public void setGBGPurchaseOrderVList(List<GBGPurchaseOrderV> gBGPurchaseOrderVList) {
        set(PROPERTY_GBGPURCHASEORDERVLIST, gBGPurchaseOrderVList);
    }
