...
public class Product extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PROCUREMENTREQUISITIONLINEEMGPRPPRODUCTIDLIST = "procurementRequisitionLineEMGprPproductIDList";
    ...
    public Product() {
        ...
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONLINEEMGPRPPRODUCTIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<RequisitionLine> getProcurementRequisitionLineEMGprPproductIDList() {
      return (List<RequisitionLine>) get(PROPERTY_PROCUREMENTREQUISITIONLINEEMGPRPPRODUCTIDLIST);
    }

    public void setProcurementRequisitionLineEMGprPproductIDList(List<RequisitionLine> procurementRequisitionLineEMGprPproductIDList) {
        set(PROPERTY_PROCUREMENTREQUISITIONLINEEMGPRPPRODUCTIDLIST, procurementRequisitionLineEMGprPproductIDList);
    }
