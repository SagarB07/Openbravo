...
public class ProductCategory extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PROCUREMENTREQUISITIONLINEEMGPRPPRODUCTCATEGORYIDLIST = "procurementRequisitionLineEMGprPproductCategoryIDList";
    ...
    public ProductCategory() {
        ...
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONLINEEMGPRPPRODUCTCATEGORYIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<RequisitionLine> getProcurementRequisitionLineEMGprPproductCategoryIDList() {
      return (List<RequisitionLine>) get(PROPERTY_PROCUREMENTREQUISITIONLINEEMGPRPPRODUCTCATEGORYIDLIST);
    }

    public void setProcurementRequisitionLineEMGprPproductCategoryIDList(List<RequisitionLine> procurementRequisitionLineEMGprPproductCategoryIDList) {
        set(PROPERTY_PROCUREMENTREQUISITIONLINEEMGPRPPRODUCTCATEGORYIDLIST, procurementRequisitionLineEMGprPproductCategoryIDList);
    }
