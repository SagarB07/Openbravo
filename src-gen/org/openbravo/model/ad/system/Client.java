...
public class Client extends BaseOBObject implements Traceable, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GAPISCSALESACCT = "gapIscsalesAcct";
    public static final String PROPERTY_GAPISCPRCHACCT = "gapIscprchAcct";
    ...
    public Client() {
        ...
        setDefaultValue(PROPERTY_GAPISCSALESACCT, false);
        setDefaultValue(PROPERTY_GAPISCPRCHACCT, false);
    ...
    public Boolean isGapIscsalesAcct() {
        return (Boolean) get(PROPERTY_GAPISCSALESACCT);
    }

    public void setGapIscsalesAcct(Boolean gapIscsalesAcct) {
        set(PROPERTY_GAPISCSALESACCT, gapIscsalesAcct);
    }

    public Boolean isGapIscprchAcct() {
        return (Boolean) get(PROPERTY_GAPISCPRCHACCT);
    }

    public void setGapIscprchAcct(Boolean gapIscprchAcct) {
        set(PROPERTY_GAPISCPRCHACCT, gapIscprchAcct);
    }
