...
public class User extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_FINANCIALMGMTASSETEMGASNAMAPEMEGANGLIST = "financialMgmtAssetEMGasNamapemegangList";
    public static final String PROPERTY_GASHISTORICALASSETPICIDLIST = "gASHISTORICALASSETPICIDList";
    public static final String PROPERTY_GMMMASTERDEPARTMENTLIST = "gMMMASTERDEPARTMENTList";
    public static final String PROPERTY_GPPPERSPEMBELIANLIST = "gPPPERSPEMBELIANList";
    public static final String PROPERTY_GPPPERSPEMBELIANDIPERIKSAIDLIST = "gPPPERSPEMBELIANDiperiksaIDList";
    public static final String PROPERTY_GPPPERSPEMBELIANDIRKEUIDLIST = "gPPPERSPEMBELIANDirkeuIDList";
    public static final String PROPERTY_GPPPERSPEMBELIANMANKEUIDLIST = "gPPPERSPEMBELIANMankeuIDList";
    ...
    public static final String PROPERTY_GUMKUMKLIST = "gumkUmkList";
    ...
    public User() {
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTASSETEMGASNAMAPEMEGANGLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_GASHISTORICALASSETPICIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_GMMMASTERDEPARTMENTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_GPPPERSPEMBELIANLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_GPPPERSPEMBELIANDIPERIKSAIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_GPPPERSPEMBELIANDIRKEUIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_GPPPERSPEMBELIANMANKEUIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_GUMKUMKLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Asset> getFinancialMgmtAssetEMGasNamapemegangList() {
      return (List<Asset>) get(PROPERTY_FINANCIALMGMTASSETEMGASNAMAPEMEGANGLIST);
    }

    public void setFinancialMgmtAssetEMGasNamapemegangList(List<Asset> financialMgmtAssetEMGasNamapemegangList) {
        set(PROPERTY_FINANCIALMGMTASSETEMGASNAMAPEMEGANGLIST, financialMgmtAssetEMGasNamapemegangList);
    }

    @SuppressWarnings("unchecked")
    public List<GasHistoricalAsset> getGASHISTORICALASSETPICIDList() {
      return (List<GasHistoricalAsset>) get(PROPERTY_GASHISTORICALASSETPICIDLIST);
    }

    public void setGASHISTORICALASSETPICIDList(List<GasHistoricalAsset> gASHISTORICALASSETPICIDList) {
        set(PROPERTY_GASHISTORICALASSETPICIDLIST, gASHISTORICALASSETPICIDList);
    }

    @SuppressWarnings("unchecked")
    public List<GmmMasterDepartment> getGMMMASTERDEPARTMENTList() {
      return (List<GmmMasterDepartment>) get(PROPERTY_GMMMASTERDEPARTMENTLIST);
    }

    public void setGMMMASTERDEPARTMENTList(List<GmmMasterDepartment> gMMMASTERDEPARTMENTList) {
        set(PROPERTY_GMMMASTERDEPARTMENTLIST, gMMMASTERDEPARTMENTList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GppPerspembelian> getGPPPERSPEMBELIANDiperiksaIDList() {
      return (List<GppPerspembelian>) get(PROPERTY_GPPPERSPEMBELIANDIPERIKSAIDLIST);
    }

    public void setGPPPERSPEMBELIANDiperiksaIDList(List<GppPerspembelian> gPPPERSPEMBELIANDiperiksaIDList) {
        set(PROPERTY_GPPPERSPEMBELIANDIPERIKSAIDLIST, gPPPERSPEMBELIANDiperiksaIDList);
    }

    @SuppressWarnings("unchecked")
    public List<GppPerspembelian> getGPPPERSPEMBELIANDirkeuIDList() {
      return (List<GppPerspembelian>) get(PROPERTY_GPPPERSPEMBELIANDIRKEUIDLIST);
    }

    public void setGPPPERSPEMBELIANDirkeuIDList(List<GppPerspembelian> gPPPERSPEMBELIANDirkeuIDList) {
        set(PROPERTY_GPPPERSPEMBELIANDIRKEUIDLIST, gPPPERSPEMBELIANDirkeuIDList);
    }

    @SuppressWarnings("unchecked")
    public List<GppPerspembelian> getGPPPERSPEMBELIANMankeuIDList() {
      return (List<GppPerspembelian>) get(PROPERTY_GPPPERSPEMBELIANMANKEUIDLIST);
    }

    public void setGPPPERSPEMBELIANMankeuIDList(List<GppPerspembelian> gPPPERSPEMBELIANMankeuIDList) {
        set(PROPERTY_GPPPERSPEMBELIANMANKEUIDLIST, gPPPERSPEMBELIANMankeuIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GumkUmk> getGumkUmkList() {
      return (List<GumkUmk>) get(PROPERTY_GUMKUMKLIST);
    }

    public void setGumkUmkList(List<GumkUmk> gumkUmkList) {
        set(PROPERTY_GUMKUMKLIST, gumkUmkList);
    }
