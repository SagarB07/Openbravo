...
public class RequisitionLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GPRPPRODUCTCATEGORY = "gprPproductCategory";
    public static final String PROPERTY_GPRPPRODUCT = "gprPproduct";
    ...
    public ProductCategory getGprPproductCategory() {
        return (ProductCategory) get(PROPERTY_GPRPPRODUCTCATEGORY);
    }

    public void setGprPproductCategory(ProductCategory gprPproductCategory) {
        set(PROPERTY_GPRPPRODUCTCATEGORY, gprPproductCategory);
    }

    public Product getGprPproduct() {
        return (Product) get(PROPERTY_GPRPPRODUCT);
    }

    public void setGprPproduct(Product gprPproduct) {
        set(PROPERTY_GPRPPRODUCT, gprPproduct);
    }
