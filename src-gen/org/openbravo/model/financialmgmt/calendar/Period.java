...
import com.gai.module.data.GAIWorksheetV;
...
public class Period extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GAIWORKSHEETVLIST = "gAIWORKSHEETVList";
    ...
    public Period() {
        ...
        setDefaultValue(PROPERTY_GAIWORKSHEETVLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<GAIWorksheetV> getGAIWORKSHEETVList() {
      return (List<GAIWorksheetV>) get(PROPERTY_GAIWORKSHEETVLIST);
    }

    public void setGAIWORKSHEETVList(List<GAIWorksheetV> gAIWORKSHEETVList) {
        set(PROPERTY_GAIWORKSHEETVLIST, gAIWORKSHEETVList);
    }
