...
public class Year extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GJITRANSACTIONLIST = "gJITransactionList";
    ...
    public Year() {
        ...
        setDefaultValue(PROPERTY_GJITRANSACTIONLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<GJITransaction> getGJITransactionList() {
      return (List<GJITransaction>) get(PROPERTY_GJITRANSACTIONLIST);
    }

    public void setGJITransactionList(List<GJITransaction> gJITransactionList) {
        set(PROPERTY_GJITRANSACTIONLIST, gJITransactionList);
    }
