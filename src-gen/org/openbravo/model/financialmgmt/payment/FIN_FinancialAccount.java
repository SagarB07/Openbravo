...
import com.gai.module.data.GaiInvoiceDetail;
...
public class FIN_FinancialAccount extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GACNOPERKIRAAN = "gacNoperkiraan";
    ...
    public static final String PROPERTY_GAIINVOICEDETAILLIST = "gaiInvoiceDetailList";
    ...
    public FIN_FinancialAccount() {
        ...
        setDefaultValue(PROPERTY_GAIINVOICEDETAILLIST, new ArrayList<Object>());
    ...
    public String getGacNoperkiraan() {
        return (String) get(PROPERTY_GACNOPERKIRAAN);
    }

    public void setGacNoperkiraan(String gacNoperkiraan) {
        set(PROPERTY_GACNOPERKIRAAN, gacNoperkiraan);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GaiInvoiceDetail> getGaiInvoiceDetailList() {
      return (List<GaiInvoiceDetail>) get(PROPERTY_GAIINVOICEDETAILLIST);
    }

    public void setGaiInvoiceDetailList(List<GaiInvoiceDetail> gaiInvoiceDetailList) {
        set(PROPERTY_GAIINVOICEDETAILLIST, gaiInvoiceDetailList);
    }
