...
public class FIN_Payment extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    // nor OBCriteria. 
    public static final String COMPUTED_COLUMN_GMMSTATUSPOSTED = "gMMStatusposted";
    ...
    public Boolean isGMMStatusposted() {
        return (Boolean) get(COMPUTED_COLUMN_GMMSTATUSPOSTED);
    }

    public void setGMMStatusposted(Boolean gMMStatusposted) {
        set(COMPUTED_COLUMN_GMMSTATUSPOSTED, gMMStatusposted);
    }

    public FIN_Payment_ComputedColumns get_computedColumns() {
        return (FIN_Payment_ComputedColumns) get(PROPERTY__COMPUTEDCOLUMNS);
    }

    public void set_computedColumns(FIN_Payment_ComputedColumns _computedColumns) {
    ...
    public Object get(String propName) {
      if (COMPUTED_COLUMN_GMMSTATUSPOSTED.equals(propName)) {
        if (get_computedColumns() == null) {
          return null;
        }
        return get_computedColumns().isGMMStatusposted();
      }
