...
public class FIN_FinancialAccountAccounting extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GAPUNCLASSRCACCT = "gapUnclassRcAcct";
    ...
    public AccountingCombination getGapUnclassRcAcct() {
        return (AccountingCombination) get(PROPERTY_GAPUNCLASSRCACCT);
    }

    public void setGapUnclassRcAcct(AccountingCombination gapUnclassRcAcct) {
        set(PROPERTY_GAPUNCLASSRCACCT, gapUnclassRcAcct);
    }
