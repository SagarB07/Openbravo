...
public class AccountingFact extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GCSISCASHFLOW = "gcsIscashflow";
    public static final String PROPERTY_GAIDOCUMENTNO = "gaiDocumentno";
    public static final String PROPERTY_GCSFLAGCS = "gcsFlagcs";
    public static final String PROPERTY_GAIKANTOR = "gaiKantor";
    public static final String PROPERTY_GCSJOURNALCODE = "gcsJournalcode";
    ...
    public AccountingFact() {
        ...
        setDefaultValue(PROPERTY_GCSISCASHFLOW, false);
        setDefaultValue(PROPERTY_GCSFLAGCS, false);
    ...
    public Boolean isGcsIscashflow() {
        return (Boolean) get(PROPERTY_GCSISCASHFLOW);
    }

    public void setGcsIscashflow(Boolean gcsIscashflow) {
        set(PROPERTY_GCSISCASHFLOW, gcsIscashflow);
    }

    public String getGaiDocumentno() {
        return (String) get(PROPERTY_GAIDOCUMENTNO);
    }

    public void setGaiDocumentno(String gaiDocumentno) {
        set(PROPERTY_GAIDOCUMENTNO, gaiDocumentno);
    }

    public Boolean isGcsFlagcs() {
        return (Boolean) get(PROPERTY_GCSFLAGCS);
    }

    public void setGcsFlagcs(Boolean gcsFlagcs) {
        set(PROPERTY_GCSFLAGCS, gcsFlagcs);
    }
    ...
    public String getGcsJournalcode() {
        return (String) get(PROPERTY_GCSJOURNALCODE);
    }

    public void setGcsJournalcode(String gcsJournalcode) {
        set(PROPERTY_GCSJOURNALCODE, gcsJournalcode);
    }
