...
public class AccountingReport extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GARRPTNAME = "garRptname";
    ...
    public String getGarRptname() {
        return (String) get(PROPERTY_GARRPTNAME);
    }

    public void setGarRptname(String garRptname) {
        set(PROPERTY_GARRPTNAME, garRptname);
    }
