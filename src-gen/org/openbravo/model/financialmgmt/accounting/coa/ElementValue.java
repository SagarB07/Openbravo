...
public class ElementValue extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GARPOSITION = "garPosition";
    ...
    public static final String PROPERTY_GJITRANSACTIONDETAILLIST = "gJITransactionDetailList";
    ...
    public ElementValue() {
        ...
        setDefaultValue(PROPERTY_GJITRANSACTIONDETAILLIST, new ArrayList<Object>());
    ...
    public String getGarPosition() {
        return (String) get(PROPERTY_GARPOSITION);
    }

    public void setGarPosition(String garPosition) {
        set(PROPERTY_GARPOSITION, garPosition);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GJITransactionDetail> getGJITransactionDetailList() {
      return (List<GJITransactionDetail>) get(PROPERTY_GJITRANSACTIONDETAILLIST);
    }

    public void setGJITransactionDetailList(List<GJITransactionDetail> gJITransactionDetailList) {
        set(PROPERTY_GJITRANSACTIONDETAILLIST, gJITransactionDetailList);
    }
