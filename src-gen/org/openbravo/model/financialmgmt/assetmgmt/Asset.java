...
import com.gai.asset.data.GASMaintenance;
...
public class Asset extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_GASBUTTONASSET = "gasButtonAsset";
    public static final String PROPERTY_GASSAVED = "gasSaved";
    public static final String PROPERTY_GASSTATUS = "gasStatus";
    public static final String PROPERTY_PROCESSASSET = "processAsset";
    public static final String PROPERTY_GASISGARANSI = "gasIsgaransi";
    public static final String PROPERTY_GASTANGGALAWALGARANSI = "gasTanggalawalgaransi";
    public static final String PROPERTY_GASTANGGALAKHIRGARANSI = "gasTanggalakhirgaransi";
    public static final String PROPERTY_GASAPPROVEWO = "gasApprovewo";
    public static final String PROPERTY_GASINVENTORY = "gasInventory";
    public static final String PROPERTY_GASSERIALNO = "gasSerialno";
    public static final String PROPERTY_GASALAMATSC = "gasAlamatsc";
    public static final String PROPERTY_GASDOCTYPE = "gasDoctype";
    public static final String PROPERTY_GASKONDISIASSET = "gasKondisiasset";
    public static final String PROPERTY_GASNAMAPEMEGANG = "gasNamapemegang";
    public static final String PROPERTY_GASTGLMOVE = "gasTglmove";
    ...
    public static final String PROPERTY_GASORDERLINE = "gasOrderline";
    ...
    public static final String PROPERTY_GASHISTORICALASSETLIST = "gASHISTORICALASSETList";
    public static final String PROPERTY_GASMAINTENANCELIST = "gASMaintenanceList";
    ...
    public Asset() {
        ...
        setDefaultValue(PROPERTY_GASBUTTONASSET, false);
        setDefaultValue(PROPERTY_GASSAVED, false);
        setDefaultValue(PROPERTY_GASSTATUS, "PDS");
        setDefaultValue(PROPERTY_PROCESSASSET, "N");
        setDefaultValue(PROPERTY_GASISGARANSI, false);
        setDefaultValue(PROPERTY_GASAPPROVEWO, false);
        ...
        setDefaultValue(PROPERTY_GASHISTORICALASSETLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_GASMAINTENANCELIST, new ArrayList<Object>());
    ...
    public Boolean isGasButtonAsset() {
        return (Boolean) get(PROPERTY_GASBUTTONASSET);
    }

    public void setGasButtonAsset(Boolean gasButtonAsset) {
        set(PROPERTY_GASBUTTONASSET, gasButtonAsset);
    }

    public Boolean isGasSaved() {
        return (Boolean) get(PROPERTY_GASSAVED);
    }

    public void setGasSaved(Boolean gasSaved) {
        set(PROPERTY_GASSAVED, gasSaved);
    }

    public String getGasStatus() {
        return (String) get(PROPERTY_GASSTATUS);
    }

    public void setGasStatus(String gasStatus) {
        set(PROPERTY_GASSTATUS, gasStatus);
    }
    ...
    public Boolean isGasIsgaransi() {
        return (Boolean) get(PROPERTY_GASISGARANSI);
    }

    public void setGasIsgaransi(Boolean gasIsgaransi) {
        set(PROPERTY_GASISGARANSI, gasIsgaransi);
    }

    public Date getGasTanggalawalgaransi() {
        return (Date) get(PROPERTY_GASTANGGALAWALGARANSI);
    }

    public void setGasTanggalawalgaransi(Date gasTanggalawalgaransi) {
        set(PROPERTY_GASTANGGALAWALGARANSI, gasTanggalawalgaransi);
    }

    public Date getGasTanggalakhirgaransi() {
        return (Date) get(PROPERTY_GASTANGGALAKHIRGARANSI);
    }

    public void setGasTanggalakhirgaransi(Date gasTanggalakhirgaransi) {
        set(PROPERTY_GASTANGGALAKHIRGARANSI, gasTanggalakhirgaransi);
    }

    public Boolean isGasApprovewo() {
        return (Boolean) get(PROPERTY_GASAPPROVEWO);
    }

    public void setGasApprovewo(Boolean gasApprovewo) {
        set(PROPERTY_GASAPPROVEWO, gasApprovewo);
    }

    public InventoryCount getGasInventory() {
        return (InventoryCount) get(PROPERTY_GASINVENTORY);
    }

    public void setGasInventory(InventoryCount gasInventory) {
        set(PROPERTY_GASINVENTORY, gasInventory);
    }

    public String getGasSerialno() {
        return (String) get(PROPERTY_GASSERIALNO);
    }

    public void setGasSerialno(String gasSerialno) {
        set(PROPERTY_GASSERIALNO, gasSerialno);
    }

    public String getGasAlamatsc() {
        return (String) get(PROPERTY_GASALAMATSC);
    }

    public void setGasAlamatsc(String gasAlamatsc) {
        set(PROPERTY_GASALAMATSC, gasAlamatsc);
    }

    public DocumentType getGasDoctype() {
        return (DocumentType) get(PROPERTY_GASDOCTYPE);
    }

    public void setGasDoctype(DocumentType gasDoctype) {
        set(PROPERTY_GASDOCTYPE, gasDoctype);
    }

    public String getGasKondisiasset() {
        return (String) get(PROPERTY_GASKONDISIASSET);
    }

    public void setGasKondisiasset(String gasKondisiasset) {
        set(PROPERTY_GASKONDISIASSET, gasKondisiasset);
    }

    public User getGasNamapemegang() {
        return (User) get(PROPERTY_GASNAMAPEMEGANG);
    }

    public void setGasNamapemegang(User gasNamapemegang) {
        set(PROPERTY_GASNAMAPEMEGANG, gasNamapemegang);
    }

    public Date getGasTglmove() {
        return (Date) get(PROPERTY_GASTGLMOVE);
    }

    public void setGasTglmove(Date gasTglmove) {
        set(PROPERTY_GASTGLMOVE, gasTglmove);
    }
    ...
    public OrderLine getGasOrderline() {
        return (OrderLine) get(PROPERTY_GASORDERLINE);
    }

    public void setGasOrderline(OrderLine gasOrderline) {
        set(PROPERTY_GASORDERLINE, gasOrderline);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<GasHistoricalAsset> getGASHISTORICALASSETList() {
      return (List<GasHistoricalAsset>) get(PROPERTY_GASHISTORICALASSETLIST);
    }

    public void setGASHISTORICALASSETList(List<GasHistoricalAsset> gASHISTORICALASSETList) {
        set(PROPERTY_GASHISTORICALASSETLIST, gASHISTORICALASSETList);
    }

    @SuppressWarnings("unchecked")
    public List<GASMaintenance> getGASMaintenanceList() {
      return (List<GASMaintenance>) get(PROPERTY_GASMAINTENANCELIST);
    }

    public void setGASMaintenanceList(List<GASMaintenance> gASMaintenanceList) {
        set(PROPERTY_GASMAINTENANCELIST, gASMaintenanceList);
    }
