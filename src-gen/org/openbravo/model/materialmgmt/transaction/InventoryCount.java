...
public class InventoryCount extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_CGOSPROCESS = "cgosProcess";
    public static final String PROPERTY_GINDOCTYPE = "ginDoctype";
    ...
    public static final String PROPERTY_FINANCIALMGMTASSETEMGASINVENTORYIDLIST = "financialMgmtAssetEMGasInventoryIDList";
    ...
    public InventoryCount() {
        ...
        setDefaultValue(PROPERTY_CGOSPROCESS, false);
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTASSETEMGASINVENTORYIDLIST, new ArrayList<Object>());
    ...
    public Boolean isCgosProcess() {
        return (Boolean) get(PROPERTY_CGOSPROCESS);
    }

    public void setCgosProcess(Boolean cgosProcess) {
        set(PROPERTY_CGOSPROCESS, cgosProcess);
    }

    public String getGinDoctype() {
        return (String) get(PROPERTY_GINDOCTYPE);
    }

    public void setGinDoctype(String ginDoctype) {
        set(PROPERTY_GINDOCTYPE, ginDoctype);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Asset> getFinancialMgmtAssetEMGasInventoryIDList() {
      return (List<Asset>) get(PROPERTY_FINANCIALMGMTASSETEMGASINVENTORYIDLIST);
    }

    public void setFinancialMgmtAssetEMGasInventoryIDList(List<Asset> financialMgmtAssetEMGasInventoryIDList) {
        set(PROPERTY_FINANCIALMGMTASSETEMGASINVENTORYIDLIST, financialMgmtAssetEMGasInventoryIDList);
    }
