...
String strParamAD_Window_ID = vars.getSessionValue(tabId + "|paramAD_Window_ID");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("adTabId") == null || dataField.getField("adTabId").equals("")) {
        ...
        String strTable_Data_Origin_Type = TabData.selectAux294C4E2D7138493CA62CD990018832D9(this, ((dataField!=null)?dataField.getField("adTableId"):((data==null || data.length==0)?"":data[0].adTableId)));
