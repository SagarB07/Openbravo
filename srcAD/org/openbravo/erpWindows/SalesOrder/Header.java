...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    vars.setSessionValue(windowId + "|PromotionsDefined", strPromotionsDefined);
        String strAPRM_OrderIsPaid = HeaderData.selectAux9FF4321DE0E5487B8A649A444F3F64BC(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].cOrderId)));
