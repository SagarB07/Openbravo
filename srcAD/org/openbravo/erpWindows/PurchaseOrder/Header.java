  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("09AD42FFD46B4750B3CE0B6308E5B7EE")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("09AD42FFD46B4750B3CE0B6308E5B7EE");
        SessionInfo.setModuleId("99493070BB374932A133B5A8DE34D3C9");
        if (securedProcess || explicitAccess.contains("09AD42FFD46B4750B3CE0B6308E5B7EE")) {
          classInfo.type = "P";
          classInfo.id = "09AD42FFD46B4750B3CE0B6308E5B7EE";
        }
      }
...
vars.getRequestGlobalVariable("inpParamGrandTotal_f", tabId + "|paramGrandTotal_f");
      ...
      response.sendRedirect(strDireccion + request.getServletPath());
     ...
     } else if (vars.commandIn("BUTTONDocAction09AD42FFD46B4750B3CE0B6308E5B7EE")) {
        vars.setSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.strdocaction", vars.getStringParameter("inpdocaction"));
        vars.setSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.strClient", vars.getStringParameter("inpadClientId"));
        vars.setSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.inpdocstatus", vars.getRequiredStringParameter("inpdocstatus"));
        ...
        vars.setSessionObject("button09AD42FFD46B4750B3CE0B6308E5B7EE.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "09AD42FFD46B4750B3CE0B6308E5B7EE", request.getServletPath());    
     } else if (vars.commandIn("BUTTON09AD42FFD46B4750B3CE0B6308E5B7EE")) {
        String strC_Order_ID = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID", "");
        String strdocaction = vars.getSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.strdocaction");
        String strProcessing = vars.getSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.strProcessing");
        String strOrg = vars.getSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.strOrg");
        String strClient = vars.getSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.strClient");
        
        String strdocstatus = vars.getSessionValue("button09AD42FFD46B4750B3CE0B6308E5B7EE.inpdocstatus");
String stradTableId = "259";
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonDocAction09AD42FFD46B4750B3CE0B6308E5B7EE(response, vars, strC_Order_ID, strdocaction, strProcessing, strdocstatus, stradTableId);
        }
    ...
    } else if (vars.commandIn("SAVE_BUTTONDocAction09AD42FFD46B4750B3CE0B6308E5B7EE")) {
        ...
        try {
          ...
          PInstanceProcessData.insertPInstance(this, pinstance, "09AD42FFD46B4750B3CE0B6308E5B7EE", (("C_Order_ID".equalsIgnoreCase("AD_Language"))?"0":strC_Order_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strAPRM_OrderIsPaid = HeaderData.selectAux874CCFB2FE7B40D79D2B0AE27951853F(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].cOrderId)));
...
comboTableData = null;
xmlDocument.setParameter("EM_Gpr_Offerdate_Format", vars.getSessionValue("#AD_SqlDateFormat"));
comboTableData = new ComboTableData(vars, this, "17", "EM_Gpr_Pengiriman_Via", "360A10C18BEF4232896D7581D119074C", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emGprPengirimanVia"):dataField.getField("emGprPengirimanVia")));
xmlDocument.setData("reportEM_Gpr_Pengiriman_Via","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
xmlDocument.setParameter("buttonEM_Gpr_Fob", Utility.messageBD(this, "Calc", vars.getLanguage()));
...
xmlDocument.setParameter("DocAction_BTNname", Utility.getButtonName(this, vars, "FF80818130217A35013021A672400035", (dataField==null?data[0].getField("docaction"):dataField.getField("docaction")), "DocAction_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalDocAction = org.openbravo.erpCommon.utility.Utility.isModalProcess("09AD42FFD46B4750B3CE0B6308E5B7EE"); 
...
xmlDocument.setParameter("DatePrinted_Format", vars.getSessionValue("#AD_SqlDateFormat"));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonDocAction09AD42FFD46B4750B3CE0B6308E5B7EE(HttpServletResponse response, VariablesSecureApp vars, String strC_Order_ID, String strdocaction, String strProcessing, String strdocstatus, String stradTableId)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 09AD42FFD46B4750B3CE0B6308E5B7EE");
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "09AD42FFD46B4750B3CE0B6308E5B7EE");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("09AD42FFD46B4750B3CE0B6308E5B7EE");
        vars.removeMessage("09AD42FFD46B4750B3CE0B6308E5B7EE");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
