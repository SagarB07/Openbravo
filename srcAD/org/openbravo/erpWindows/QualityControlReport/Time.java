...
vars.getGlobalVariable("inpmaMeasureGroupId", windowId + "|MA_Measure_Group_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPMA_Measure_Group_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|MA_Measure_Group_ID", data[0].maMeasureGroupId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);
  ...
  private String getParentID(VariablesSecureApp vars, String strMA_Measure_Time_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|MA_Measure_Time_ID", data[0].getField("maMeasureTimeId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
