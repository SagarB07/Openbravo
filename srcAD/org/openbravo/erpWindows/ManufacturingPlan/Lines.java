...
vars.getGlobalVariable("inpmrpRunProductionId", windowId + "|MRP_Run_Production_ID");
  ...
  private String getParentID(VariablesSecureApp vars, String strMRP_Run_Productionline_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|Inouttrxtype", data[0].getField("inouttrxtype"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|MRP_Run_Productionline_ID", data[0].getField("mrpRunProductionlineId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
