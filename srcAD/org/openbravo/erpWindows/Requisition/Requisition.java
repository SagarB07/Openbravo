...
String stradTableId = "800212";
  ...
  private RequisitionData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    try {
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.emGprNofilling = vars.getStringParameter("inpemGprNofilling");     data.description = vars.getStringParameter("inpdescription");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.adUserId = vars.getRequiredStringParameter("inpadUserId");     data.adUserIdr = vars.getStringParameter("inpadUserId_R");     data.mPricelistId = vars.getRequestGlobalVariable("inpmPricelistId", windowId + "|M_PriceList_ID");     data.mPricelistIdr = vars.getStringParameter("inpmPricelistId_R");     data.cCurrencyId = vars.getRequestGlobalVariable("inpcCurrencyId", windowId + "|C_Currency_ID");     data.cCurrencyIdr = vars.getStringParameter("inpcCurrencyId_R");     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.docstatus = vars.getRequiredStringParameter("inpdocstatus");     data.emGbgBudgetId = vars.getStringParameter("inpemGbgBudgetId");     data.emGmmMasterDepartmentId = vars.getStringParameter("inpemGmmMasterDepartmentId");     data.emGprPerihal = vars.getStringParameter("inpemGprPerihal");     data.emGrqReceivestatus = vars.getRequiredStringParameter("inpemGrqReceivestatus");     data.emGrqReceivestatusr = vars.getStringParameter("inpemGrqReceivestatus_R");     data.emGnvMasterDatadireksiId = vars.getStringParameter("inpemGnvMasterDatadireksiId");     data.emGnvMasterDatadireksi2Id = vars.getStringParameter("inpemGnvMasterDatadireksi2Id");     data.emGnvMasterDatadireksi3Id = vars.getStringParameter("inpemGnvMasterDatadireksi3Id");     data.emGmmDiperikasId = vars.getStringParameter("inpemGmmDiperikasId");     data.emGmmDisetujuiId = vars.getStringParameter("inpemGmmDisetujuiId");     data.emGmmDisetujui2Id = vars.getStringParameter("inpemGmmDisetujui2Id");     data.emGmmDisetujui3Id = vars.getStringParameter("inpemGmmDisetujui3Id");     data.emGmmDisetujui4Id = vars.getStringParameter("inpemGmmDisetujui4Id");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.processing = vars.getStringParameter("inpprocessing", "N");     data.mRequisitionId = vars.getRequestGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.createpo = vars.getRequiredStringParameter("inpcreatepo"); 
...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = RequisitionData.set(Utility.getDefault(this, vars, "EM_Gpr_Perihal", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gmm_Diperikas_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "Createpo", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "800092", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField))), Utility.getDefault(this, vars, "Processed", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "AD_User_ID", "@#AD_User_ID@", "800092", "", dataField), Utility.getDefault(this, vars, "Processing", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "EM_Gpr_Nofilling", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Grq_Receivestatus", "NR", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gnv_Master_Datadireksi2_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gmm_Master_Department_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gnv_Master_Datadireksi_ID", "", "800092", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800092", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800092", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "800092", "", dataField), RequisitionData.selectDef803534_0(this, Utility.getDefault(this, vars, "Createdby", "", "800092", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800092", "", dataField), RequisitionData.selectDef803536_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800092", "", dataField)), Utility.getDefault(this, vars, "Description", "", "800092", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "800092", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "", dataField), RequisitionData.selectDef803539_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "", dataField)), Utility.getDefault(this, vars, "M_PriceList_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gmm_Disetujui4_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gnv_Master_Datadireksi3_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gmm_Disetujui2_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gmm_Disetujui3_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gmm_Disetujui_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "EM_Gbg_Budget_ID", "", "800092", "", dataField));
