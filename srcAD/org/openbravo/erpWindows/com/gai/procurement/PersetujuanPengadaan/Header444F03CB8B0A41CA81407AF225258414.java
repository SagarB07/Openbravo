...
public class Header444F03CB8B0A41CA81407AF225258414 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Header444F03CB8B0A41CA81407AF225258414.class);
  
  private static final String windowId = "A65CD36EB19C4261869E83B4C9EDC3F6";
  private static final String tabId = "444F03CB8B0A41CA81407AF225258414";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Header444F03CB8B0A41CA81407AF225258414.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|Header444F03CB8B0A41CA81407AF225258414.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamDocStatus", tabId + "|paramDocStatus");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_Requisition_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Header444F03CB8B0A41CA81407AF225258414.view", strView);
        }
      }
      ...
      String strM_Requisition_ID = vars.getGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID", "");
      vars.setSessionValue(tabId + "|Header444F03CB8B0A41CA81407AF225258414.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|Header444F03CB8B0A41CA81407AF225258414.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|Header444F03CB8B0A41CA81407AF225258414.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Header444F03CB8B0A41CA81407AF225258414.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_Requisition_ID");
      ...
      String strM_Requisition_ID = vars.getRequiredStringParameter("inpmRequisitionId");
      //Header444F03CB8B0A41CA81407AF225258414Data data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Header444F03CB8B0A41CA81407AF225258414Data.delete(this, strM_Requisition_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
String stradTableId = "800212";
        ...
        try {
          ...
          Header444F03CB8B0A41CA81407AF225258414Data.updateDocAction(this, strdocaction, strM_Requisition_ID);
...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/gai/procurement/PersetujuanPengadaan/Header444F03CB8B0A41CA81407AF225258414_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header444F03CB8B0A41CA81407AF225258414", false, "document.frmMain.inpmRequisitionId", "grid", "..", "".equals("Y"), "PersetujuanPengadaan", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header444F03CB8B0A41CA81407AF225258414_Relation.html", "PersetujuanPengadaan", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header444F03CB8B0A41CA81407AF225258414_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Requisition_ID, TableSQLData tableSQL)
    ...
    Header444F03CB8B0A41CA81407AF225258414Data[] data=null;
...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Header444F03CB8B0A41CA81407AF225258414Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strM_Requisition_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Header444F03CB8B0A41CA81407AF225258414Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Header444F03CB8B0A41CA81407AF225258414Data.set(Utility.getDefault(this, vars, "EM_Gpp_Persetujuan", "N", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField), Utility.getDefault(this, vars, "Createpo", "N", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField))), Utility.getDefault(this, vars, "Processed", "N", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField), Utility.getDefault(this, vars, "AD_User_ID", "@#AD_User_ID@", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Processing", "N", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField), Utility.getDefault(this, vars, "EM_Gpr_Nomorpenawaran", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "EM_Gpr_Tanggalpenawaran", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Header444F03CB8B0A41CA81407AF225258414Data.selectDef803534_0(this, Utility.getDefault(this, vars, "Createdby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Header444F03CB8B0A41CA81407AF225258414Data.selectDef803536_1(this, Utility.getDefault(this, vars, "Updatedby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField)), Utility.getDefault(this, vars, "Description", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Header444F03CB8B0A41CA81407AF225258414Data.selectDef803539_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField)), Utility.getDefault(this, vars, "M_PriceList_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "EM_Gmm_Metodepembelian_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "EM_Gpp_Btnpersetujuan", "N", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField), Utility.getDefault(this, vars, "EM_Gbg_Budget_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/gai/procurement/PersetujuanPengadaan/Header444F03CB8B0A41CA81407AF225258414_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/gai/procurement/PersetujuanPengadaan/Header444F03CB8B0A41CA81407AF225258414_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header444F03CB8B0A41CA81407AF225258414", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmRequisitionId", "", "..", "".equals("Y"), "PersetujuanPengadaan", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Requisition_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header444F03CB8B0A41CA81407AF225258414_Relation.html", "PersetujuanPengadaan", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header444F03CB8B0A41CA81407AF225258414_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("EM_Gpp_Btnpersetujuan_BTNname", Utility.getButtonName(this, vars, "1EBD4C5E3410469EA77CC3B1D9333E79", "EM_Gpp_Btnpersetujuan_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Gpp_Btnpersetujuan = org.openbravo.erpCommon.utility.Utility.isModalProcess("427DD76F78784831B02040B33F9822A1"); 
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Header444F03CB8B0A41CA81407AF225258414_Edition.html");
...
xmlDocument.setParameter("array", dact.toString());
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Header444F03CB8B0A41CA81407AF225258414Data.getCurrentDBTimestamp(this, data.mRequisitionId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Header444F03CB8B0A41CA81407AF225258414. This Servlet was made by Wad constructor";
