...
public class Lines4AF6EC5A157545958201842DF529BE81 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static Logger log4j = Logger.getLogger(Lines4AF6EC5A157545958201842DF529BE81.class);
  
  private static final String windowId = "A65CD36EB19C4261869E83B4C9EDC3F6";
  private static final String tabId = "4AF6EC5A157545958201842DF529BE81";
  private static final String defaultTabView = "RELATION";
  private static final int accesslevel = 1;
  private static final String moduleId = "9C5AF1AA041149E48C7091EF40C2A426";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Lines4AF6EC5A157545958201842DF529BE81.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(windowId + "|M_Requisition_ID", strPM_Requisition_ID);
      vars.setSessionValue("444F03CB8B0A41CA81407AF225258414|Header.view", "EDIT");

      refreshParentSession(vars, strPM_Requisition_ID);

      vars.setSessionValue(tabId + "|Lines4AF6EC5A157545958201842DF529BE81.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamNeedbydate_f", tabId + "|paramNeedbydate_f");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_Requisitionline_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Lines4AF6EC5A157545958201842DF529BE81.view", strView);
        }
      }
      ...
      String strM_Requisitionline_ID = vars.getGlobalVariable("inpmRequisitionlineId", windowId + "|M_Requisitionline_ID", "");
      vars.setSessionValue(tabId + "|Lines4AF6EC5A157545958201842DF529BE81.view", "RELATION");
...
vars.getGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID");
      ...
      vars.setSessionValue(tabId + "|Lines4AF6EC5A157545958201842DF529BE81.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPM_Requisition_ID = vars.getGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Lines4AF6EC5A157545958201842DF529BE81.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Lines4AF6EC5A157545958201842DF529BE81.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_Requisitionline_ID");
      vars.setSessionValue(windowId + "|M_Requisition_ID", strPM_Requisition_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      ...
      String strM_Requisitionline_ID = vars.getRequiredStringParameter("inpmRequisitionlineId");
      //Lines4AF6EC5A157545958201842DF529BE81Data data = getEditVariables(vars, strPM_Requisition_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = Lines4AF6EC5A157545958201842DF529BE81Data.delete(this, strM_Requisitionline_ID, strPM_Requisition_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_Requisition_ID) throws IOException,ServletException {
      ...
      Header444F03CB8B0A41CA81407AF225258414Data[] data = Header444F03CB8B0A41CA81407AF225258414Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Requisition_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
  ...
  private String getParentID(VariablesSecureApp vars, String strM_Requisitionline_ID) throws ServletException {
    String strPM_Requisition_ID = Lines4AF6EC5A157545958201842DF529BE81Data.selectParentID(this, strM_Requisitionline_ID);
    if (strPM_Requisition_ID.equals("")) {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|M_Product_ID", data[0].getField("mProductId"));    vars.setSessionValue(windowId + "|M_PriceList_ID", data[0].getField("mPricelistId"));    vars.setSessionValue(windowId + "|M_Requisitionline_ID", data[0].getField("mRequisitionlineId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars, String strPM_Requisition_ID) throws IOException,ServletException {
      Lines4AF6EC5A157545958201842DF529BE81Data[] data = Lines4AF6EC5A157545958201842DF529BE81Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Requisition_ID, vars.getStringParameter("inpmRequisitionlineId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamNeedbydate_f = vars.getSessionValue(tabId + "|paramNeedbydate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/gai/procurement/PersetujuanPengadaan/Lines4AF6EC5A157545958201842DF529BE81_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Lines4AF6EC5A157545958201842DF529BE81", false, "document.frmMain.inpmRequisitionlineId", "grid", "..", "".equals("Y"), "PersetujuanPengadaan", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
    ...
    xmlDocument.setParameter("parentFieldName", Utility.getFieldName("04B810443FAC45B9ACB513D037924209", vars.getLanguage()));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines4AF6EC5A157545958201842DF529BE81_Relation.html", "PersetujuanPengadaan", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Lines4AF6EC5A157545958201842DF529BE81_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", Lines4AF6EC5A157545958201842DF529BE81Data.selectParent(this, strPM_Requisition_ID));
    else xmlDocument.setParameter("parent", Lines4AF6EC5A157545958201842DF529BE81Data.selectParentTrl(this, strPM_Requisition_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean boolNew, String strM_Requisitionline_ID, String strPM_Requisition_ID, TableSQLData tableSQL)
    ...
    Lines4AF6EC5A157545958201842DF529BE81Data[] data=null;
...
String strParamNeedbydate_f = vars.getSessionValue(tabId + "|paramNeedbydate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = Lines4AF6EC5A157545958201842DF529BE81Data.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPM_Requisition_ID, strM_Requisitionline_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      ...
      if (boolNew || data==null || data.length==0) {
        ...
        strCommand = "NEW";
        data = new Lines4AF6EC5A157545958201842DF529BE81Data[0];
      } else {
        discard[0] = new String ("newDiscard");
      }
    } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = Lines4AF6EC5A157545958201842DF529BE81Data.set(strPM_Requisition_ID, Utility.getDefault(this, vars, "C_BPartner_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Lines4AF6EC5A157545958201842DF529BE81Data.selectDef1004400000_0(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField)), Utility.getDefault(this, vars, "C_UOM_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Lines4AF6EC5A157545958201842DF529BE81Data.selectDef1004400004_1(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField)), Utility.getDefault(this, vars, "Reqstatus", "O", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Orderedqty", "0", "A65CD36EB19C4261869E83B4C9EDC3F6", "0", dataField), Utility.getDefault(this, vars, "Description", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Changestatus", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "N", dataField), Utility.getDefault(this, vars, "Internalnotes", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Suppliernotes", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Needbydate", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "PriceActual", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Discount", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Lockedby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Lockqty", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Lockprice", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Lockdate", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Lockcause", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Lines4AF6EC5A157545958201842DF529BE81Data.selectDef1004400040(this, strPM_Requisition_ID), Utility.getDefault(this, vars, "Gross_Amt", "0", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Lines4AF6EC5A157545958201842DF529BE81Data.selectDef803547_2(this, Utility.getDefault(this, vars, "Createdby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Lines4AF6EC5A157545958201842DF529BE81Data.selectDef803549_3(this, Utility.getDefault(this, vars, "Updatedby", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField)), Utility.getDefault(this, vars, "M_Product_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Lines4AF6EC5A157545958201842DF529BE81Data.selectDef803552_4(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField)), Utility.getDefault(this, vars, "Qty", "1", "A65CD36EB19C4261869E83B4C9EDC3F6", "0", dataField), Utility.getDefault(this, vars, "PriceList", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField), Utility.getDefault(this, vars, "Gross_Unit_Price", "0", "A65CD36EB19C4261869E83B4C9EDC3F6", "", dataField));
        
      }
     }
      
    String currentPOrg=Header444F03CB8B0A41CA81407AF225258414Data.selectOrg(this, strPM_Requisition_ID);
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/gai/procurement/PersetujuanPengadaan/Lines4AF6EC5A157545958201842DF529BE81_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/com/gai/procurement/PersetujuanPengadaan/Lines4AF6EC5A157545958201842DF529BE81_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines4AF6EC5A157545958201842DF529BE81", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmRequisitionlineId", "", "..", "".equals("Y"), "PersetujuanPengadaan", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Requisitionline_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines4AF6EC5A157545958201842DF529BE81_Relation.html", "PersetujuanPengadaan", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Lines4AF6EC5A157545958201842DF529BE81_Relation.html", strReplaceWith);
...
comboTableData = null;
xmlDocument.setParameter("Changestatus_BTNname", Utility.getButtonName(this, vars, "2DECF72764C346AF9845109276844DBB", "Changestatus_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalChangestatus = org.openbravo.erpCommon.utility.Utility.isModalProcess("1004400002"); 
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Lines4AF6EC5A157545958201842DF529BE81_Edition.html");
    ...
    private String getDisplayLogicContext(VariablesSecureApp vars, boolean isNew) throws IOException, ServletException {
      ...
      String result = "var strATTRIBUTESET=\"" +Utility.getContext(this, vars, "ATTRIBUTESET", windowId) + "\";\nvar strATTRSETVALUETYPE=\"" +Utility.getContext(this, vars, "ATTRSETVALUETYPE", windowId) + "\";\nvar strGROSSPRICE=\"" +Utility.getContext(this, vars, "GROSSPRICE", windowId) + "\";\nvar strHASSECONDUOM=\"" +Utility.getContext(this, vars, "HASSECONDUOM", windowId) + "\";\nvar strShowAudit=\"" +(isNew?"N":Utility.getContext(this, vars, "ShowAudit", windowId)) + "\";\n";
      return result;
    }
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (Lines4AF6EC5A157545958201842DF529BE81Data.getCurrentDBTimestamp(this, data.mRequisitionlineId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Lines4AF6EC5A157545958201842DF529BE81. This Servlet was made by Wad constructor";
