...
vars.getRequestGlobalVariable("inpParamEM_Gac_Noperkiraan", tabId + "|paramEM_Gac_Noperkiraan");
  ...
  private AccountData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|Fin_Financial_Account_ID", data[0].getField("finFinancialAccountId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
...
String strParamEM_Gac_Noperkiraan = vars.getSessionValue(tabId + "|paramEM_Gac_Noperkiraan");

    boolean hasSearchCondition=false;
    vars.removeEditionData(tabId);
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamName) && ("").equals(strParamC_Currency_ID) && ("").equals(strParamEM_Gac_Noperkiraan)) || !(("").equals(strParamName) || ("%").equals(strParamName))  || !(("").equals(strParamC_Currency_ID) || ("%").equals(strParamC_Currency_ID))  || !(("").equals(strParamEM_Gac_Noperkiraan) || ("%").equals(strParamEM_Gac_Noperkiraan)) ;
