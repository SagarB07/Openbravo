...
vars.getGlobalVariable("inpcProjectId", windowId + "|C_Project_ID");
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Project_Vendor_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|C_Project_Vendor_ID", data[0].getField("cProjectVendorId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
