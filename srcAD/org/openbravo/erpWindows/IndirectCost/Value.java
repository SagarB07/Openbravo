...
vars.getGlobalVariable("inpmaIndirectCostId", windowId + "|MA_Indirect_Cost_ID");
  ...
  private String getParentID(VariablesSecureApp vars, String strMA_Indirect_Cost_Value_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|MA_Indirect_Cost_Value_ID", data[0].getField("maIndirectCostValueId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));
    }
