  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("01B8BA57EF7742D4810EF7529846393C")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("01B8BA57EF7742D4810EF7529846393C");
        SessionInfo.setModuleId("34212FF693C745799092C7FE200C55DA");
        if (securedProcess || explicitAccess.contains("01B8BA57EF7742D4810EF7529846393C")) {
          classInfo.type = "P";
          classInfo.id = "01B8BA57EF7742D4810EF7529846393C";
        }
      }
...
vars.getRequestGlobalVariable("inpParamAmortizationcalctype", tabId + "|paramAmortizationcalctype");
      ...
      response.sendRedirect(strDireccion + request.getServletPath());
     ...
     } else if (vars.commandIn("BUTTONEM_Gas_Approvewo01B8BA57EF7742D4810EF7529846393C")) {
        vars.setSessionValue("button01B8BA57EF7742D4810EF7529846393C.stremGasApprovewo", vars.getStringParameter("inpemGasApprovewo"));
        vars.setSessionValue("button01B8BA57EF7742D4810EF7529846393C.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button01B8BA57EF7742D4810EF7529846393C.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button01B8BA57EF7742D4810EF7529846393C.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("button01B8BA57EF7742D4810EF7529846393C.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "01B8BA57EF7742D4810EF7529846393C", request.getServletPath());    
     } else if (vars.commandIn("BUTTON01B8BA57EF7742D4810EF7529846393C")) {
        String strA_Asset_ID = vars.getGlobalVariable("inpaAssetId", windowId + "|A_Asset_ID", "");
        String stremGasApprovewo = vars.getSessionValue("button01B8BA57EF7742D4810EF7529846393C.stremGasApprovewo");
        String strProcessing = vars.getSessionValue("button01B8BA57EF7742D4810EF7529846393C.strProcessing");
        String strOrg = vars.getSessionValue("button01B8BA57EF7742D4810EF7529846393C.strOrg");
        String strClient = vars.getSessionValue("button01B8BA57EF7742D4810EF7529846393C.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Gas_Approvewo01B8BA57EF7742D4810EF7529846393C(response, vars, strA_Asset_ID, stremGasApprovewo, strProcessing);
        }
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONEM_Gas_Approvewo01B8BA57EF7742D4810EF7529846393C")) {
        String strA_Asset_ID = vars.getGlobalVariable("inpKey", windowId + "|A_Asset_ID", "");
        @SuppressWarnings("unused")
        String stremGasApprovewo = vars.getStringParameter("inpemGasApprovewo");
        String strProcessing = vars.getStringParameter("inpprocessing");
        OBError myMessage = null;
        try {
          String pinstance = SequenceIdData.getUUID();
          PInstanceProcessData.insertPInstance(this, pinstance, "01B8BA57EF7742D4810EF7529846393C", (("A_Asset_ID".equalsIgnoreCase("AD_Language"))?"0":strA_Asset_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
  ...
  private AssetsData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.emGasDoctypeId = vars.getStringParameter("inpemGasDoctypeId");     data.value = vars.getStringParameter("inpvalue");     data.name = vars.getRequiredStringParameter("inpname");     data.aAssetGroupId = vars.getRequiredStringParameter("inpaAssetGroupId");     data.aAssetGroupIdr = vars.getStringParameter("inpaAssetGroupId_R");     data.documentno = vars.getStringParameter("inpdocumentno");     data.description = vars.getStringParameter("inpdescription");     data.cCurrencyId = vars.getStringParameter("inpcCurrencyId");     data.cCurrencyIdr = vars.getStringParameter("inpcCurrencyId_R");     data.emGasOrderlineId = vars.getStringParameter("inpemGasOrderlineId");     data.mProductId = vars.getRequestGlobalVariable("inpmProductId", windowId + "|M_Product_ID");     data.mProductIdr = vars.getStringParameter("inpmProductId_R");     data.mLocatorId = vars.getStringParameter("inpmLocatorId");     data.mLocatorIdr = vars.getStringParameter("inpmLocatorId_R");     data.issummary = vars.getStringParameter("inpissummary", "N");     data.isstatic = vars.getStringParameter("inpisstatic", "N");     data.emGasStatus = vars.getRequiredStringParameter("inpemGasStatus");     data.emGasStatusr = vars.getStringParameter("inpemGasStatus_R");     data.emGasTglmove = vars.getRequiredStringParameter("inpemGasTglmove");     data.emGmmMasterDepartmentId = vars.getRequiredStringParameter("inpemGmmMasterDepartmentId");     data.isdepreciated = vars.getStringParameter("inpisdepreciated", "N");     data.emGaiKantorId = vars.getStringParameter("inpemGaiKantorId");     data.emGasNamapemegang = vars.getRequiredStringParameter("inpemGasNamapemegang");     data.emGasKondisiasset = vars.getStringParameter("inpemGasKondisiasset");     data.emGasKondisiassetr = vars.getStringParameter("inpemGasKondisiasset_R");     data.amortizationtype = vars.getRequiredStringParameter("inpamortizationtype");     data.amortizationtyper = vars.getStringParameter("inpamortizationtype_R");     data.amortizationcalctype = vars.getRequiredGlobalVariable("inpamortizationcalctype", windowId + "|Amortizationcalctype");     data.amortizationcalctyper = vars.getStringParameter("inpamortizationcalctype_R");    try {   data.annualamortizationpercentage = vars.getNumericParameter("inpannualamortizationpercentage");  } catch (ServletException paramEx) { ex = paramEx; }     data.assetschedule = vars.getRequiredStringParameter("inpassetschedule");     data.assetscheduler = vars.getStringParameter("inpassetschedule_R");    try {   data.uselifeyears = vars.getNumericParameter("inpuselifeyears");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.uselifemonths = vars.getNumericParameter("inpuselifemonths");  } catch (ServletException paramEx) { ex = paramEx; }     data.is30daymonth = vars.getStringParameter("inpis30daymonth", "N");     data.datepurchased = vars.getStringParameter("inpdatepurchased");     data.datecancelled = vars.getStringParameter("inpdatecancelled");     data.amortizationstartdate = vars.getStringParameter("inpamortizationstartdate");     data.amortizationenddate = vars.getStringParameter("inpamortizationenddate");    try {   data.assetvalueamt = vars.getNumericParameter("inpassetvalueamt");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.residualassetvalueamt = vars.getNumericParameter("inpresidualassetvalueamt");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.amortizationvalueamt = vars.getNumericParameter("inpamortizationvalueamt");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.depreciatedpreviousamt = vars.getNumericParameter("inpdepreciatedpreviousamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.processed = vars.getRequiredStringParameter("inpprocessed");    try {   data.depreciatedvalue = vars.getNumericParameter("inpdepreciatedvalue");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.depreciatedplan = vars.getNumericParameter("inpdepreciatedplan");  } catch (ServletException paramEx) { ex = paramEx; }     data.isfullydepreciated = vars.getStringParameter("inpisfullydepreciated", "N");     data.mAttributesetinstanceId = vars.getStringParameter("inpmAttributesetinstanceId");     data.isactive = vars.getStringParameter("inpisactive", "N");    try {   data.qty = vars.getNumericParameter("inpqty");  } catch (ServletException paramEx) { ex = paramEx; }     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.processAsset = vars.getRequiredStringParameter("inpprocessAsset");     data.emGasButtonAsset = vars.getStringParameter("inpemGasButtonAsset");     data.emGasSaved = vars.getStringParameter("inpemGasSaved", "N");     data.emGasInventoryId = vars.getStringParameter("inpemGasInventoryId");     data.emGasIsgaransi = vars.getStringParameter("inpemGasIsgaransi", "N");     data.emGasSerialno = vars.getStringParameter("inpemGasSerialno");     data.emGasAlamatsc = vars.getStringParameter("inpemGasAlamatsc");     data.emGasTanggalawalgaransi = vars.getStringParameter("inpemGasTanggalawalgaransi");     data.emGasTanggalakhirgaransi = vars.getStringParameter("inpemGasTanggalakhirgaransi");     data.emGasApprovewo = vars.getStringParameter("inpemGasApprovewo");    try {   data.lifeuseunits = vars.getNumericParameter("inplifeuseunits");  } catch (ServletException paramEx) { ex = paramEx; }     data.isinposession = vars.getStringParameter("inpisinposession", "N");    try {   data.profit = vars.getNumericParameter("inpprofit");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.acctvalueamt = vars.getNumericParameter("inpacctvalueamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.aAssetId = vars.getRequestGlobalVariable("inpaAssetId", windowId + "|A_Asset_ID");     data.cBpartnerLocationId = vars.getStringParameter("inpcBpartnerLocationId");     data.cLocationId = vars.getStringParameter("inpcLocationId");     data.isdisposed = vars.getStringParameter("inpisdisposed", "N");     data.assetdisposaldate = vars.getStringParameter("inpassetdisposaldate");     data.assetservicedate = vars.getStringParameter("inpassetservicedate");     data.adUserId = vars.getStringParameter("inpadUserId");    try {   data.useunits = vars.getNumericParameter("inpuseunits");  } catch (ServletException paramEx) { ex = paramEx; }     data.assetdepreciationdate = vars.getStringParameter("inpassetdepreciationdate");     data.guaranteedate = vars.getStringParameter("inpguaranteedate");     data.isowned = vars.getStringParameter("inpisowned", "N");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.lot = vars.getStringParameter("inplot");     data.help = vars.getStringParameter("inphelp");     data.locationcomment = vars.getStringParameter("inplocationcomment");     data.versionno = vars.getStringParameter("inpversionno");     data.serno = vars.getStringParameter("inpserno");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
          ...
          vars.getGlobalVariable("inpgasIsmaintenance", windowId + "|GAS_IsMaintenance", "");
...
String strParamAmortizationcalctype = vars.getSessionValue(tabId + "|paramAmortizationcalctype");
    ...
    vars.setSessionValue(windowId + "|existAmortizationLines", strexistAmortizationLines);
        String strGAS_IsMaintenance = AssetsData.selectAuxAC59D3426EB64B3B9A81E84936327146(this, ((dataField!=null)?dataField.getField("aAssetId"):((data==null || data.length==0)?"":data[0].aAssetId)));
    vars.setSessionValue(windowId + "|GAS_IsMaintenance", strGAS_IsMaintenance);
    
    
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        refreshSessionNew(vars);
        data = AssetsData.set(Utility.getDefault(this, vars, "Process_Asset", "N", "800027", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "800042", Utility.getDefault(this, vars, "Process_Asset", "N", "800027", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "800042", Utility.getDefault(this, vars, "Process_Asset", "N", "800027", "N", dataField))), Utility.getDefault(this, vars, "EM_Gas_Inventory_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "EM_Gas_Status", "PDS", "800027", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "800027", "", dataField), AssetsData.selectDef3808ABE5D08E4650A2DE65596DB61F49_0(this, Utility.getDefault(this, vars, "C_Project_ID", "", "800027", "", dataField)), Utility.getDefault(this, vars, "EM_Gas_Serialno", "", "800027", "", dataField), Utility.getDefault(this, vars, "EM_Gas_Saved", "N", "800027", "N", dataField), Utility.getDefault(this, vars, "EM_Gas_Tglmove", "", "800027", "", dataField), Utility.getDefault(this, vars, "EM_Gmm_Master_Department_ID", "", "800027", "", dataField), AssetsData.selectDef7FB29BF27B5243019CA9FC9BE7BE6F25(this), Utility.getDefault(this, vars, "Datepurchased", "", "800027", "", dataField), Utility.getDefault(this, vars, "Datecancelled", "", "800027", "", dataField), Utility.getDefault(this, vars, "Amortizationstartdate", "", "800027", "", dataField), Utility.getDefault(this, vars, "Amortizationenddate", "", "800027", "", dataField), Utility.getDefault(this, vars, "Annualamortizationpercentage", "", "800027", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "800027", "", dataField), Utility.getDefault(this, vars, "AssetValueAmt", "", "800027", "", dataField), Utility.getDefault(this, vars, "Residualassetvalueamt", "", "800027", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "Acctvalueamt", "", "800027", "", dataField), Utility.getDefault(this, vars, "Amortizationtype", "", "800027", "", dataField), Utility.getDefault(this, vars, "Amortizationvalueamt", "", "800027", "", dataField), Utility.getDefault(this, vars, "Assetschedule", "", "800027", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "800027", "", dataField), Utility.getDefault(this, vars, "Processed", "N", "800027", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "800042", Utility.getDefault(this, vars, "Processed", "N", "800027", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "800042", Utility.getDefault(this, vars, "Processed", "N", "800027", "N", dataField))), Utility.getDefault(this, vars, "Profit", "", "800027", "", dataField), Utility.getDefault(this, vars, "Qty", "", "800027", "", dataField), Utility.getDefault(this, vars, "Depreciatedvalue", "0", "800027", "", dataField), Utility.getDefault(this, vars, "Depreciatedplan", "0", "800027", "", dataField), Utility.getDefault(this, vars, "Amortizationcalctype", "", "800027", "", dataField), Utility.getDefault(this, vars, "Depreciatedpreviousamt", "0", "800027", "", dataField), Utility.getDefault(this, vars, "Lot", "", "800027", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "IsDisposed", "", "800027", "N", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "IsInPosession", "", "800027", "N", dataField), "Y", Utility.getDefault(this, vars, "AssetDepreciationDate", "", "800027", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "800027", "", dataField), AssetsData.selectDef8045_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "800027", "", dataField)), Utility.getDefault(this, vars, "UseLifeYears", "", "800027", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "800027", "", dataField), AssetsData.selectDef8047_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "800027", "", dataField)), Utility.getDefault(this, vars, "AssetDisposalDate", "", "800027", "", dataField), Utility.getDefault(this, vars, "C_Location_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "A_Asset_Group_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "800027", "", dataField), Utility.getDefault(this, vars, "VersionNo", "", "800027", "", dataField), Utility.getDefault(this, vars, "Value", "", "800027", "", dataField), Utility.getDefault(this, vars, "IsOwned", "", "800027", "N", dataField), Utility.getDefault(this, vars, "Name", "", "800027", "", dataField), Utility.getDefault(this, vars, "Description", "", "800027", "", dataField), Utility.getDefault(this, vars, "LocationComment", "", "800027", "", dataField), Utility.getDefault(this, vars, "IsDepreciated", "", "800027", "N", dataField), Utility.getDefault(this, vars, "LifeUseUnits", "", "800027", "", dataField), Utility.getDefault(this, vars, "Help", "", "800027", "", dataField), Utility.getDefault(this, vars, "UpdatedBy", "", "800027", "", dataField), AssetsData.selectDef8063_3(this, Utility.getDefault(this, vars, "UpdatedBy", "", "800027", "", dataField)), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800027", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "GuaranteeDate", "", "800027", "", dataField), Utility.getDefault(this, vars, "UseLifeMonths", "", "800027", "", dataField), Utility.getDefault(this, vars, "AssetServiceDate", "", "800027", "", dataField), Utility.getDefault(this, vars, "UseUnits", "", "800027", "", dataField), "", Utility.getDefault(this, vars, "SerNo", "", "800027", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "EM_Gas_Tanggalakhirgaransi", "", "800027", "", dataField), Utility.getDefault(this, vars, "IsFullyDepreciated", "N", "800027", "N", dataField), Utility.getDefault(this, vars, "EM_Gas_Button_Asset", "", "800027", "N", dataField), Utility.getDefault(this, vars, "EM_Gas_Tanggalawalgaransi", "", "800027", "", dataField), Utility.getDefault(this, vars, "EM_Gai_Kantor_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "EM_Gas_Namapemegang", "", "800027", "", dataField), Utility.getDefault(this, vars, "EM_Gas_Orderline_ID", "", "800027", "", dataField), Utility.getDefault(this, vars, "IsStatic", "N", "800027", "N", dataField), Utility.getDefault(this, vars, "Issummary", "N", "800027", "N", dataField), Utility.getDefault(this, vars, "EM_Gas_Kondisiasset", "", "800027", "", dataField), Utility.getDefault(this, vars, "EM_Gas_Approvewo", "", "800027", "N", dataField), Utility.getDefault(this, vars, "EM_Gas_Isgaransi", "N", "800027", "N", dataField), Utility.getDefault(this, vars, "Is30DayMonth", "Y", "800027", "N", dataField), Utility.getDefault(this, vars, "EM_Gas_Alamatsc", "", "800027", "", dataField));
    ...
    try {
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("GAS_IsMaintenance", strGAS_IsMaintenance);
...
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "19", "M_Locator_ID", "", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("mLocatorId"):dataField.getField("mLocatorId")));
xmlDocument.setData("reportM_Locator_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "17", "EM_Gas_Status", "A6741E037151406D84B819B76BB26CCA", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emGasStatus"):dataField.getField("emGasStatus")));
xmlDocument.setData("reportEM_Gas_Status","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
xmlDocument.setParameter("EM_Gas_Tglmove_Format", vars.getSessionValue("#AD_SqlDateFormat"));
comboTableData = new ComboTableData(vars, this, "17", "EM_Gas_Kondisiasset", "0240EFB1169144FCB821036D12E39740", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emGasKondisiasset"):dataField.getField("emGasKondisiasset")));
xmlDocument.setData("reportEM_Gas_Kondisiasset","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
...
xmlDocument.setParameter("EM_Gas_Button_Asset_BTNname", Utility.getButtonName(this, vars, "3B510372FAC04472AFA8310A2DE51E1B", "EM_Gas_Button_Asset_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Gas_Button_Asset = org.openbravo.erpCommon.utility.Utility.isModalProcess("59408D0D6CF541D4A39C7BA477CF7E5C"); 
xmlDocument.setParameter("EM_Gas_Button_Asset_Modal", modalEM_Gas_Button_Asset?"true":"false");
xmlDocument.setParameter("EM_Gas_Tanggalawalgaransi_Format", vars.getSessionValue("#AD_SqlDateFormat"));
xmlDocument.setParameter("EM_Gas_Tanggalakhirgaransi_Format", vars.getSessionValue("#AD_SqlDateFormat"));
xmlDocument.setParameter("EM_Gas_Approvewo_BTNname", Utility.getButtonName(this, vars, "B95455B0935647EDAC99D489CBDCE783", "EM_Gas_Approvewo_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Gas_Approvewo = org.openbravo.erpCommon.utility.Utility.isModalProcess("01B8BA57EF7742D4810EF7529846393C"); 
xmlDocument.setParameter("EM_Gas_Approvewo_Modal", modalEM_Gas_Approvewo?"true":"false");
...
xmlDocument.setParameter("buttonProfit", Utility.messageBD(this, "Calc", vars.getLanguage()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonEM_Gas_Approvewo01B8BA57EF7742D4810EF7529846393C(HttpServletResponse response, VariablesSecureApp vars, String strA_Asset_ID, String stremGasApprovewo, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 01B8BA57EF7742D4810EF7529846393C");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Gas_Approvewo01B8BA57EF7742D4810EF7529846393C", discard).createXmlDocument();
      xmlDocument.setParameter("key", strA_Asset_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Assets_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "01B8BA57EF7742D4810EF7529846393C");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("01B8BA57EF7742D4810EF7529846393C");
        vars.removeMessage("01B8BA57EF7742D4810EF7529846393C");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
