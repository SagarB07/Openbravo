  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      printPageDefault(response, vars, strProcessId);
        ...
        printPageButton5465AEBF3EFB4B2D9B94E16121D9F0FF(response, vars, strProcessId);
    ...
    } else if (vars.commandIn("SAVE_BUTTONActionButton5465AEBF3EFB4B2D9B94E16121D9F0FF")) {
        process5465AEBF3EFB4B2D9B94E16121D9F0FF(strProcessId, vars, request, response);
...
comboTableData = null;
    ...
    void printPageButton5465AEBF3EFB4B2D9B94E16121D9F0FF(HttpServletResponse response, VariablesSecureApp vars, String strProcessId)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 5465AEBF3EFB4B2D9B94E16121D9F0FF");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/ActionButton5465AEBF3EFB4B2D9B94E16121D9F0FF", discard).createXmlDocument();
      xmlDocument.setParameter("processing", "Y");
      xmlDocument.setParameter("form", "ActionButtonJava_Responser.html");
      xmlDocument.setParameter("css", vars.getTheme());
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
...
params.put("action", straction);
    ...
    private void process5465AEBF3EFB4B2D9B94E16121D9F0FF(String strProcessId, VariablesSecureApp vars, HttpServletRequest request, HttpServletResponse response) throws IOException,
      ServletException {
        ...
        OBError myMessage = null;
        try {
          new com.gai.othergoodsshipment.erpCommon.ad_process.OtherGoodsShipment().execute(pb);
          myMessage = (OBError) pb.getResult();
          myMessage.setMessage(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getMessage()));
          myMessage.setTitle(Utility.parseTranslation(this, vars, vars.getLanguage(), myMessage.getTitle()));
        } catch (Exception ex) {
