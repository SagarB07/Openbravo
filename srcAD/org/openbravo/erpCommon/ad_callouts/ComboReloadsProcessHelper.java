...
public class ComboReloadsProcessHelper extends CalloutHelper {
  ...
  void printPage(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
   String strProcessId = vars.getStringParameter("inpadProcessId");
     ...
     if (strProcessId.equals("DA808C70756D4F9088FF40026735E30A")) {
       processDA808C70756D4F9088FF40026735E30A(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("C42E7AD64D714B10A7F90F6B4D427D7A")) {
       processC42E7AD64D714B10A7F90F6B4D427D7A(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("583A645A5C024D7EA1812E5008C200D4")) {
       process583A645A5C024D7EA1812E5008C200D4(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("88B1201F5A244FCE8FCD138151529190")) {
       process88B1201F5A244FCE8FCD138151529190(response, vars, strTabId, windowId);
       return;
     }
    
     if (strProcessId.equals("6833F564B3FA4CB3B083633E5B6D15EB")) {
       process6833F564B3FA4CB3B083633E5B6D15EB(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("9C5575FE256D4AF892793E6223ABC3B0")) {
       process9C5575FE256D4AF892793E6223ABC3B0(response, vars, strTabId, windowId);
       return;
     }
     ...
     if (strProcessId.equals("00BB884C671B4C11BE4BA5537BEE2B0D")) {
       process00BB884C671B4C11BE4BA5537BEE2B0D(response, vars, strTabId, windowId);
       return;
     }
    ...
    private void processDA808C70756D4F9088FF40026735E30A(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsDA808C70756D4F9088FF40026735E30A';\n\n");
        resultado.append("var respuesta = new Array(\n");
      ...
      if (CalloutHelper.commandInCommandList(command, "inpadOrgId")) {
        if (!isFirst) resultado.append(", \n");
        comboTableData = new ComboTableData(vars, this, "17", "Jenis", "5E5EA77ECCB842118B90EC29F4BF24CF", "", Utility.getReferenceableOrg(vars, vars.getStringParameter("inpadOrgId")), Utility.getContext(this, vars, "#User_Client", windowId), 0);
        comboTableData.fillParameters(null, windowId, "");
        resultField = "inpjenis";
    ...
    private void processC42E7AD64D714B10A7F90F6B4D427D7A(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloadsC42E7AD64D714B10A7F90F6B4D427D7A';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process583A645A5C024D7EA1812E5008C200D4(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads583A645A5C024D7EA1812E5008C200D4';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process88B1201F5A244FCE8FCD138151529190(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads88B1201F5A244FCE8FCD138151529190';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process6833F564B3FA4CB3B083633E5B6D15EB(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads6833F564B3FA4CB3B083633E5B6D15EB';\n\n");
        resultado.append("var respuesta = new Array(\n");
      ...
      if (CalloutHelper.commandInCommandList(command, "inpadOrgId")) {
        if (!isFirst) resultado.append(", \n");
        comboTableData = new ComboTableData(vars, this, "17", "BULAN", "CABD440EB1E4497F9A219F8AF654645E", "", Utility.getReferenceableOrg(vars, vars.getStringParameter("inpadOrgId")), Utility.getContext(this, vars, "#User_Client", windowId), 0);
        comboTableData.fillParameters(null, windowId, "");
        resultField = "inpbulan";
    ...
    private void process9C5575FE256D4AF892793E6223ABC3B0(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads9C5575FE256D4AF892793E6223ABC3B0';\n\n");
        resultado.append("var respuesta = new Array(\n");
    ...
    private void process00BB884C671B4C11BE4BA5537BEE2B0D(HttpServletResponse response, VariablesSecureApp vars, String strTabId, String windowId) throws IOException, ServletException {
        String resultField;
        String command = vars.getStringParameter("Command", "DEFAULT");
        XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_callouts/CallOut").createXmlDocument();
        ...
        boolean isFirst=true;
        ComboTableData comboTableData = null;
        resultado.append("var calloutName='ComboReloads00BB884C671B4C11BE4BA5537BEE2B0D';\n\n");
        resultado.append("var respuesta = new Array(\n");
