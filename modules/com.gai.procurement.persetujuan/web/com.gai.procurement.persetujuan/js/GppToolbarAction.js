(function () {   
	  ...
	  var buttonToolbarPrint = {
		  action: function(){
			...
			if (r == true) {
				...
				//if (idtab === '64152ADB14AD42569F0E290E0FE749C3' ) {  //Fund Delivery Confirmation
					command = 'PRINT_PRS'; //==java
				/*	alert('Cashflow Projection > ' +' <br>*Record : '+string_id+" ("+command+")");
				}*/
				
			postParams['Command'] = command;
			postParams['inpRecordId'] = string_id;
			OB.Utilities.openProcessPopup(OB.Application.contextUrl + '/com.gai.procurement.persetujuan.erpCommon.ad_reports/PersetujuanPrint.html', false, postParams, 200, 320);
		  ...
		  buttonType: 'gpp_toolbarprint',
		  prompt: 'Print Confirmation',
  ...
  OB.ToolbarRegistry.registerButton(buttonToolbarPrint.buttonType, isc.OBToolbarIconButton, buttonToolbarPrint, 100, ['4D5A9E56DEB04D02859A040468EC1B76']);
}());
