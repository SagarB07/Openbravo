 ...
 */
 public class GLItemProses extends IdlServiceJava {
 static Logger log4j = Logger.getLogger(GLItemProses.class);
 
 FIN_Payment finPaymentGeneral = null;
 FIN_Payment finPaymentData = null;
 GLItem gl = null;
 String flag = "";
 private static Logger log=Logger.getLogger(GLItemProses.class);
 ...
 return new Parameter[] {
	...
	new Parameter("ParGLItem", Parameter.STRING) //11
 ...
 protected Object[] validateProcess(Validator validator, String... values) throws Exception {
    ...
    validator.checkNotNull(validator.checkString(values[11], 255), "ParGLItem"); //10
	return values;
 }
...
@Override
 public BaseOBObject internalProcess(Object... values) throws Exception {
	 return createPaymentInOut((String) values[0], (String) values[1], (String) values[2],(String) values[3], (String) values[4],(String)values[5],
	 	(String) values[6],(String) values[7],(String) values[8],(String) values[9],(String) values[10],(String) values[11]);       
}
...
/* ====================================================================== */
 ...
 // Header
	...
	String partnerReceivedFrom = (ReceivedFrom.equals("") || ReceivedFrom == null || ReceivedFrom.length() == 0) ? "Harcode Unclass" : ReceivedFrom;
	...
	FIN_FinancialAccount getFinancialAccountEntity = findDALInstance(false, FIN_FinancialAccount.class, new Value(FIN_FinancialAccount.PROPERTY_NAME, Account_k));
	...
	OBDal.getInstance().flush();
        ...
        gl = OBProvider.getInstance().get(GLItem.class);	
        gl = findDALInstance(false, GLItem.class, new Value(GLItem.PROPERTY_NAME, ParGLItem)); 
        
       	OBDal.getInstance().save(gl);
	    OBDal.getInstance().flush();

		thisvars.setSessionValue("APRMT_MigrationToolRunning","N");
		processLine(finPaymentData,BigDecimal.ZERO,thisvars,thisconnProvider,gl);
	
 OBDal.getInstance().commitAndClose();
 
 this.finPaymentGeneral = null;
