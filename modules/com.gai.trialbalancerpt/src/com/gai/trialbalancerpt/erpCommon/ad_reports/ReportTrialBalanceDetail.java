  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (strDateFrom.equals("") && strDateTo.equals("") || strId.equals("")) {
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/gai/trialbalancerpt/erpCommon/ad_reports/ReportTrialBalanceDetail", discard)
          .createXmlDocument();
      data = ReportTrialBalanceDetailData.set();
    } else {
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/gai/trialbalancerpt/erpCommon/ad_reports/ReportTrialBalanceDetail").createXmlDocument();
