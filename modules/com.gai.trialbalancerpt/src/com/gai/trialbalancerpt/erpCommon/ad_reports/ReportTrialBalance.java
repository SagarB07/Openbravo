...
public class ReportTrialBalance extends HttpSecureAppServlet {
  ...
  private void printPageOpen(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      ...
      for (int i = 0; i < data.length; i++) {
        ...
        //added
        tds.put("td2", df.format(new BigDecimal(data[i].saldoInicialDebet)));
        tds.put("td3", df.format(new BigDecimal(data[i].saldoInicialCredit)));
        tds.put("td3", df.format(new BigDecimal(data[i].amtacctdr)));
        tds.put("td4", df.format(new BigDecimal(data[i].amtacctcr)));
        tds.put("td5", df.format(new BigDecimal(data[i].saldoFinalDebet)));
        tds.put("td6", df.format(new BigDecimal(data[i].saldoFinalCredit)));
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (strDateFrom.equals("") && strDateTo.equals("")) {
      xmlDocument = xmlEngine.readXmlTemplate(
          "com/gai/trialbalancerpt/erpCommon/ad_reports/ReportTrialBalance", discard).createXmlDocument();
      data = ReportTrialBalanceData.set();
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.gai.trialbalancerpt.erpCommon.ad_reports.ReportTrialBalance");
  ...
  private void printPageDataXLS(HttpServletRequest request, HttpServletResponse response,
    ...
    if (!strDateFrom.equals("") && !strDateTo.equals("") && !strOrg.equals("")
      ...
      if (data == null || data.length == 0) {
        ...
        String strReportName = "@basedesign@/com/gai/trialbalancerpt/erpCommon/ad_reports/ReportTrialBalanceExcel.jrxml";
  ...
  private void printPageDataPDF(HttpServletRequest request, HttpServletResponse response,
    ...
    if (!strDateFrom.equals("") && !strDateTo.equals("") && !strOrg.equals("")
      ...
      if (data == null || data.length == 0) {
        ...
        String strLanguage = vars.getLanguage();
        String strReportName = "@basedesign@/com/gai/trialbalancerpt/erpCommon/ad_reports/ReportTrialBalancePDF.jrxml";
        HashMap<String, Object> parameters = new HashMap<String, Object>();
  ...
  private ReportTrialBalanceData[] calculateTree(ReportTrialBalanceData[] data, String indice,
    ...
    BigDecimal totalInicialDebet = new BigDecimal((String) vecTotal.elementAt(2));
    BigDecimal totalInicialCredit = new BigDecimal((String) vecTotal.elementAt(3));
    //BigDecimal totalFinal = new BigDecimal((String) vecTotal.elementAt(4));
    BigDecimal totalFinalDebet = new BigDecimal((String) vecTotal.elementAt(4));
    BigDecimal totalFinalCredit = new BigDecimal((String) vecTotal.elementAt(5));
    ...
    for (int i = 0; i < data.length; i++) {
      if (data[i].parentId.equals(indice)) {
        ...
        BigDecimal parcialInicialDebet = new BigDecimal((String) vecParcial.elementAt(2));
        BigDecimal parcialInicialCredit = new BigDecimal((String) vecParcial.elementAt(3));
        //BigDecimal parcialFinal = new BigDecimal((String) vecParcial.elementAt(4));
        BigDecimal parcialFinalDebet = new BigDecimal((String) vecParcial.elementAt(4));
        BigDecimal parcialFinalCredit = new BigDecimal((String) vecParcial.elementAt(5));
        ...
        /*data[i].saldoInicial = (new BigDecimal(data[i].saldoInicial).add(parcialInicial))
            .toPlainString();*/
        data[i].saldoInicialDebet = (new BigDecimal(data[i].saldoInicialDebet).add(parcialInicialDebet))
            .toPlainString();
        data[i].saldoInicialCredit = (new BigDecimal(data[i].saldoInicialCredit).add(parcialInicialCredit))
            .toPlainString();        
        ...
        data[i].saldoFinalDebet = (new BigDecimal(data[i].saldoInicialDebet).add(parcialDR)
            .subtract(parcialCR)).toPlainString();
        data[i].saldoFinalCredit = (new BigDecimal(data[i].saldoInicialCredit).add(parcialDR)
            .subtract(parcialCR)).toPlainString();
...
/*              data[i].saldoInicial = (new BigDecimal(dataIB[k].saldoInicial).add(parcialInicial))
                  .toPlainString();*/
              data[i].saldoInicialDebet = (new BigDecimal(dataIB[k].saldoInicialDebet).add(parcialInicialDebet))
                  .toPlainString();
              data[i].saldoInicialCredit = (new BigDecimal(dataIB[k].saldoInicialCredit).add(parcialInicialCredit))
                  .toPlainString();        
            } else {
...
/*            data[i].saldoFinal = (new BigDecimal(dataIB[k].saldoInicial).add(parcialDR)
                .subtract(parcialCR)).toPlainString();*/
            data[i].saldoFinalDebet = (new BigDecimal(dataIB[k].saldoInicialDebet).add(parcialDR)
                .subtract(parcialCR)).toPlainString();
            data[i].saldoFinalCredit = (new BigDecimal(dataIB[k].saldoInicialCredit).add(parcialDR)
                .subtract(parcialCR)).toPlainString();            
          }
        }
        ...
        totalInicialDebet = totalInicialDebet.add(new BigDecimal(data[i].saldoInicialDebet));
        totalInicialCredit = totalInicialCredit.add(new BigDecimal(data[i].saldoInicialCredit));
        //totalFinal = totalFinal.add(new BigDecimal(data[i].saldoFinal));
        totalFinalDebet = totalFinalDebet.add(new BigDecimal(data[i].saldoFinalDebet));
        totalFinalCredit = totalFinalCredit.add(new BigDecimal(data[i].saldoFinalCredit));
    ...
    vecTotal.set(2, totalInicialDebet.toPlainString());
    vecTotal.set(3, totalInicialCredit.toPlainString());
    //vecTotal.set(4, totalFinal.toPlainString());
    vecTotal.set(4, totalFinalDebet.toPlainString());
    vecTotal.set(5, totalFinalCredit.toPlainString());
  ...
  private ReportTrialBalanceData[] dataFilter(ReportTrialBalanceData[] data) {
    ...
    for (int i = 0; i < data.length; i++) {
      if (new BigDecimal(data[i].amtacctdr).compareTo(BigDecimal.ZERO) != 0
          ...
          || new BigDecimal(data[i].saldoInicialDebet).compareTo(BigDecimal.ZERO) != 0
          || new BigDecimal(data[i].saldoInicialCredit).compareTo(BigDecimal.ZERO) != 0
  ...
  public String getServletInfo() {
    return "Servlet ReportTrialBalance. This Servlet was edited by GAI";
  }
}
