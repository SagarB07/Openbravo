...
public class GinGetArea extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    String gaiKantorId = info.getStringParameter("inpemGaiKantorId", null);

    GinGetAreaData[] data = GinGetAreaData.select(this, gaiKantorId);
    

    if (data != null && data.length > 0) {
      hasilarea=data[0].name;
    }

    info.addResult("inparea",hasilarea);
