...
public class ReCalculateInv extends HttpSecureAppServlet {
  ...
  void processAndClose(HttpServletRequest request, HttpServletResponse response,
    ...
    if (log4j.isDebugEnabled())
      ...
      try {
        ...
        CallStoredProcedure.getInstance().call("GNV_INVESTASI_RECALCULATE", params, null, true, false);

        myMessage.setTitle("Success");
        myMessage.setType("SUCCESS");
        
        myMessage.setMessage("This Record has been Re-Calculate");
  ...
  void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, 
    ...
    xmlDocument = xmlEngine.readXmlTemplate(
        "com/gai/investasi/erpCommon/ad_process/ReCalculateInv").createXmlDocument();
    ToolBar toolbar = new ToolBar(this, vars.getLanguage(),
        "ReCalculateInv", false, "", "", "", false, "ad_reports",
        strReplaceWith, false, true);
    toolbar.prepareSimpleToolBarTemplate();
    xmlDocument.setParameter("toolbar", toolbar.toString());
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "com.gai.investasi.erpCommon.ad_process.ReCalculateInv");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(),
          "ReCalculateInv.html", classInfo.id, classInfo.type, strReplaceWith, tabs
              .breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "ReCalculateInv.html",
          strReplaceWith);
    ...
    {
      OBError myMessage = vars.getMessage("ReCalculateInv");
      vars.removeMessage("ReCalculateInv");
      if (myMessage != null) {
