(function () {   
	  ...
	  var buttonToolbarPrint = {
		  action: function(){
			...
			OB.Utilities.openProcessPopup(OB.Application.contextUrl + '/com.gai.investasi.erpCommon.ad_reports/ToolbarPrint.html', false, postParams, 200, 320);
  ...
  OB.ToolbarRegistry.registerButton(buttonToolbarPrint.buttonType, isc.OBToolbarIconButton, buttonToolbarPrint, 100, ['02E0B084017140F5876333336AAAA90B']);
}());
