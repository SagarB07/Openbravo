...
public class FactLine {
  ...
  public boolean convert(String Acct_Currency_ID, String ConversionDate, String CurrencyRateType,
    ...
    // When TableID= RecDocLine_FINReconciliationonciliation info is loaded from transaction
  ...
  public boolean save(Connection con, ConnectionProvider conn, VariablesSecureApp vars)
    ...
    try {
      ...
      if (zero.compareTo(new BigDecimal(m_AmtSourceDr)) == 0
        ...
        //added by GAI Team - insert isCashflow yg sudah di setup di Chart of Account
        String isCashflow = FactLineData.selectIsCashflow(conn, Account_ID);
        //end added
        ...
        no = FactLineData.insertFactAct(con, conn, m_Fact_Acct_ID, AD_Client_ID, AD_Org_ID, vars
            ...
            C_Costcenter_ID, (m_docVO.m_IsOpening.equals("Y")) ? "O" : "N", m_DocumentNo,
            isCashflow); 
            //added m_DocumentNo, isCashflow by GAI Team
  ...
  public StringBuffer getDescription(ConnectionProvider connectionProvider,
    ...
    //added by astri
    AcctServerData[] strTableName = AcctServerData.getTableInfo(connectionProvider, strAD_Table_ID);
    String tableName = strTableName[0].tablename;
    //end added
    ...
    try {
      ...
      if (description.length() == 0) {
        //added by astri
        if (tableName.equals("FIN_Payment") || tableName.equals("GL_Journal") || tableName.equals("C_Invoice")) {
          description.append(AcctServerData.selectDescriptionHeader(connectionProvider, tableName, strRecord_ID)); 
        }
        //end added
        else {
  ...
  /**
   * @return m_DocumentNo added by astri
   */
  public String getM_DocumentNo() {
    if (m_docVO.DocumentNo != null) 
      m_DocumentNo = m_docVO.DocumentNo;
    else 
      m_DocumentNo = "";
