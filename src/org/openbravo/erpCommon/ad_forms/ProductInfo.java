...
public class ProductInfo {
  ...
  public Account getAccount(String AcctType, AcctSchema as, ConnectionProvider conn) {
    ...
    try {
      ...
      //added  
      case 13:
        validCombination_ID = data[0].productreceivable;
        break;
      }
  ...
  public Account getAccountDefault(String AcctType, AcctSchema as, ConnectionProvider conn) {
    if (Integer.parseInt(AcctType) < 1 || Integer.parseInt(AcctType) > 8 || Integer.parseInt(AcctType) < 13)
      return null;
    ProductInfoData[] data = null;
    Account acct = null;
    try {
  ...
  /** added Product Receivable */
  public static final String ACCTTYPE_P_Receivable = "13";  
